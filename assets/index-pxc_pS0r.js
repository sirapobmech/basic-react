...
server.listen(3000)
// เปิด browser ไปที่ localhost:3000 → เห็น Hello World`,yt=`// Event Loop — หัวใจของ Node.js
...
async function readFile() {
  ...
  console.log(data)
}`,bt=`// Express — framework ยอดนิยมสำหรับทำ API
...
app.listen(3000, () => console.log('Server running on port 3000'))`,xt=`// REST API — มาตรฐานการออกแบบ API
...
500 Server Error → server พัง`,St=`// Middleware — function ที่ทำงานระหว่าง request → response
...
})`,Ct=`// Router — แยก route ออกเป็นไฟล์ย่อย
...
app.use('/orders', orderRouter)  // /orders, /orders/:id`,wt=`// Error Handling
...
})`,Tt=`// Environment Variables — ค่าที่ต่างกันในแต่ละ env
...
// ✅ deploy บน server ต่างๆ ใช้ค่าต่างกันได้`,Et=`// JWT Authentication — ระบบ login ที่นิยมที่สุด
...
app.get('/me', authenticate, (req, res) => {
  res.json(req.user)
})`,Dt=[{q:`Node.js คืออะไร ต่างจาก Browser JavaScript ยังไง?`,a:`Node.js คือ JavaScript runtime บน server — ทำให้ JS รันนอก browser ได้<br><br>
    ...
    ในทางปฏิบัติส่วนใหญ่ใช้ PATCH เพราะ flexible กว่า`}];function A(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Backend`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`Node.js Backend`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน Node.js และ Express สำหรับทำ REST API พร้อม pattern ที่ใช้จริงในงาน`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Node.js คืออะไร`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Node.js คือ JavaScript runtime ที่ทำให้ JS รันบน server ได้ ก่อนหน้านี้ JS รันได้แค่ใน browser เท่านั้น`}),(0,f.jsx)(p,{code:vt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Event Loop — Non-blocking I/O`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Node.js รัน thread เดียว แต่รับ request ได้เยอะเพราะงาน I/O (อ่านไฟล์, query DB) ถูกส่งไปทำข้างหลัง ไม่บล็อก thread หลัก`}),(0,f.jsx)(p,{code:yt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Express — ทำ API`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Express คือ framework ยอดนิยมของ Node.js สำหรับทำ web server และ API ให้โครงสร้าง routing และ middleware ที่ใช้งานง่าย`}),(0,f.jsx)(p,{code:bt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`REST API Design`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`REST คือมาตรฐานการออกแบบ API โดยใช้ HTTP Method บอกว่าจะทำอะไร และ URL บอกว่าทำกับอะไร — ทำให้ API อ่านง่ายและคาดเดาได้`}),(0,f.jsx)(p,{code:xt,lang:`bash`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Middleware`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Middleware คือ function ที่ทำงานระหว่าง request เข้ามาและ response ออกไป ทุก request ผ่าน middleware ตามลำดับก่อนถึง route handler`}),(0,f.jsx)(p,{code:St,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Router — แยกไฟล์`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`เมื่อโปรเจกต์ใหญ่ขึ้น ควรแยก route ออกเป็นไฟล์ย่อยตาม resource ทำให้ code อ่านง่ายและจัดการได้ง่ายขึ้น`}),(0,f.jsx)(p,{code:Ct,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Error Handling`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ทุก async route ต้องมี try/catch และส่ง error ไปให้ error handler middleware Express มี error handler พิเศษที่รับ 4 parameter (err, req, res, next)`}),(0,f.jsx)(p,{code:wt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Environment Variables`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ค่าที่ต่างกันในแต่ละ environment เช่น DB URL, API key, password ต้องเก็บใน .env ไม่ใส่ตรงๆ ใน code และไม่ commit ขึ้น Git`}),(0,f.jsx)(p,{code:Tt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JWT Authentication`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`JWT คือ token ที่ใช้ยืนยันตัวตน — server ออก token ให้หลัง login client ส่ง token มาทุก request แทนการ login ซ้ำ`}),(0,f.jsx)(p,{code:Et,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Dt})]})]})}var Ot=`// Basic Types — ประเภทพื้นฐาน
...
type Car = { color: string }  // Error: Duplicate identifier 'Car'`,At=`// Union Type — ค่าเป็นได้หลาย type
...
getProperty(user, 'xxx')   // ❌ Error: ไม่มี key นี้`,Mt=`// Utility Types — TypeScript built-in helpers
...
// { id: number; name: string }`,Nt=`// Type Narrowing — บอก TS ว่าตอนนี้ type คืออะไร
...
useEffect(() => {
  ...
  fetchUser()
  return () => controller.abort()
}, [])`,Ft=[{q:`TypeScript คืออะไร ทำไมต้องใช้?`,a:`TypeScript คือ JavaScript + Static Type System<br><br>
    ทำไมต้องใช้:<br>
    ...
    TS จะ narrow type ให้อัตโนมัติหลัง check`}];function It(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`TypeScript`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`TypeScript`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน TypeScript ตั้งแต่พื้นฐานจนถึงการใช้งานจริงใน React เพื่อเตรียมสัมภาษณ์ Frontend Developer`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Basic Types`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📘`}),(0,f.jsx)(`span`,{children:`TypeScript = JavaScript + Type System — compile เป็น JS ธรรมดา browser ไม่รู้จัก TS เลย`})]}),(0,f.jsx)(p,{code:Ot,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Type vs Interface`}),(0,f.jsx)(p,{code:kt,lang:`typescript`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Feature`}),(0,f.jsx)(`th`,{children:`Interface`}),(0,f.jsx)(`th`,{children:`Type`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Object shape`}),(0,f.jsx)(`td`,{children:`✅`}),(0,f.jsx)(`td`,{children:`✅`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Union / Intersection`}),(0,f.jsx)(`td`,{children:`❌`}),(0,f.jsx)(`td`,{children:`✅`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`extends`}),(0,f.jsx)(`td`,{children:`✅ extends`}),(0,f.jsx)(`td`,{children:`✅ &`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Declaration Merging`}),(0,f.jsx)(`td`,{children:`✅`}),(0,f.jsx)(`td`,{children:`❌`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Primitive alias`}),(0,f.jsx)(`td`,{children:`❌`}),(0,f.jsx)(`td`,{children:`✅`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Union & Intersection Types`}),(0,f.jsx)(p,{code:At,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Generics`}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsx)(`span`,{children:`Generics คือ "type parameter" — เหมือน function parameter แต่สำหรับ type ทำให้ reusable และ type-safe พร้อมกัน`})]}),(0,f.jsx)(p,{code:jt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Utility Types`}),(0,f.jsx)(p,{code:Mt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Type Narrowing`}),(0,f.jsx)(p,{code:Nt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`TypeScript กับ React`}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚛️`}),(0,f.jsx)(`span`,{children:`React 19 + TypeScript รองรับดีมาก — type ของ Props, Hooks, และ Events ครอบคลุมทุกอย่าง`})]}),(0,f.jsx)(p,{code:Pt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Ft})]})]})}var Lt=`import { createContext, useContext, useState } from 'react'
...
}`,Rt=`// Pattern: Custom Context Hook
...
}`,zt=`// เมื่อไหรควรใช้ Context vs Props
...
// ไม่ re-render UserContext consumers เมื่อ theme เปลี่ยน`,Bt=[{q:`Context API คืออะไร และใช้แก้ปัญหาอะไร?`,a:`Context API ใช้แก้ปัญหา <strong>Prop Drilling</strong> — การส่ง props ผ่านหลาย level component ที่ไม่ได้ใช้ข้อมูลนั้นจริงๆ<br><br>
    ...
    React 19+ แนะนำ: Context สำหรับ simple, Zustand/Jotai สำหรับ complex`}],Vt=(0,l.createContext)(null);function Ht({children:e}){let[t,n]=(0,l.useState)(`dark`);return(0,f.jsx)(Vt.Provider,{value:{theme:t,setTheme:n},children:e})}function Ut(){let{theme:e,setTheme:t}=(0,l.useContext)(Vt);return(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>t(e=>e===`dark`?`light`:`dark`),children:e===`dark`?`🌙 Dark Mode`:`☀️ Light Mode`})}function Wt(){let{theme:e}=(0,l.useContext)(Vt);return(0,f.jsxs)(`div`,{style:{padding:`16px`,borderRadius:`8px`,background:e===`dark`?`#1e2535`:`#f1f5f9`,color:e===`dark`?`#e2e8f0`:`#1e293b`,border:`1px solid ${e===`dark`?`#2d3748`:`#cbd5e1`}`,marginTop:10,fontSize:14},children:[`🃏 Card component ใช้ theme จาก Context: `,(0,f.jsx)(`strong`,{children:e})]})}function Gt(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useContext — Context API`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`แชร์ state ข้าม component โดยไม่ต้องส่ง props ทุก level (แก้ Prop Drilling)`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context Basics`}),(0,f.jsx)(p,{code:Lt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context Pattern ที่แนะนำ`}),(0,f.jsx)(p,{code:Rt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Theme Context Demo`}),(0,f.jsx)(`div`,{className:`demo-content`,children:(0,f.jsxs)(Ht,{children:[(0,f.jsx)(Ut,{}),(0,f.jsx)(Wt,{})]})})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context vs Props — เลือกอันไหน?`}),(0,f.jsx)(p,{code:zt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Bt})]})]})}var Kt=`import { useEffect, useState } from 'react'
...
}`,qt=`// Cleanup Function — ป้องกัน memory leak
...
}`,Jt=`// Data Fetching Pattern ที่ถูกต้อง
...
useLayoutEffect(() => {
  ...
  setWidth(width)
}, [])`,Xt=[{q:`Dependency Array ใน useEffect คืออะไร?`,a:`Dependency Array บอก React ว่าให้ run effect เมื่อค่าใดค่าหนึ่งเปลี่ยน<br><br>
    ...
    Rule of thumb: ใช้ <code>useEffect</code> ก่อนเสมอ switch ไป <code>useLayoutEffect</code> เมื่อมีปัญหา flickering`}];function Zt(){let[e,t]=(0,l.useState)(0),[n,r]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{if(!n)return;let e=setInterval(()=>t(e=>e+1),1e3);return()=>clearInterval(e)},[n]),(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,children:[(0,f.jsxs)(`span`,{className:`demo-value`,style:{fontSize:24,minWidth:80},children:[String(Math.floor(e/60)).padStart(2,`0`),`:`,String(e%60).padStart(2,`0`)]}),(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>r(e=>!e),children:n?`⏸ Pause`:`▶ Start`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>{t(0),r(!1)},children:`Reset`})]}),(0,f.jsx)(`p`,{className:`demo-label`,style:{marginTop:10},children:`useEffect cleanup ป้องกัน interval leak`})]})}function Qt(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useEffect`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`จัดการ side effects: data fetching, subscriptions, timers, และ DOM manipulation`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useEffect Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🎣`}),(0,f.jsx)(`span`,{children:`useEffect ทำงานหลัง render เสมอ ใช้สำหรับ side effects ที่ไม่ใช่ rendering เช่น API calls, subscriptions`})]}),(0,f.jsx)(p,{code:Kt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Cleanup Function`}),(0,f.jsx)(p,{code:qt}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Timer Demo — useEffect + Cleanup`}),(0,f.jsx)(Zt,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Data Fetching Pattern`}),(0,f.jsxs)(`div`,{className:`callout callout-warn`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚠️`}),(0,f.jsxs)(`span`,{children:[`ใน React 19 ควรพิจารณาใช้ `,(0,f.jsx)(`code`,{children:`use()`}),` hook หรือ library เช่น TanStack Query แทนการ fetch ใน useEffect เพื่อจัดการ loading/error states ได้ดีกว่า`]})]}),(0,f.jsx)(p,{code:Jt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Effect Execution Order`}),(0,f.jsx)(p,{code:Yt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Xt})]})]})}var $t=`import { useReducer } from 'react'
...
}`,en=`// Real-world example: Todo List with useReducer
...
}`,tn=`// useReducer vs useState — เลือกอันไหน?
...
// Redux = global store ที่แชร์ระหว่าง components`,nn=[{q:`useReducer คืออะไร เมื่อไหรควรใช้แทน useState?`,a:`useReducer เป็น hook ที่ใช้ pattern <code>(state, action) => newState</code> แบบเดียวกับ Redux<br><br>
    ...
    React ใช้ strict mode run reducer 2 ครั้งเพื่อ detect side effects`}],rn={todos:[],filter:`all`};function an(e,t){switch(t.type){case`ADD`:return t.payload.trim()?{...e,todos:[...e.todos,{id:Date.now(),text:t.payload,done:!1}]}:e;case`TOGGLE`:return{...e,todos:e.todos.map(e=>e.id===t.payload?{...e,done:!e.done}:e)};case`DELETE`:return{...e,todos:e.todos.filter(e=>e.id!==t.payload)};case`FILTER`:return{...e,filter:t.payload};default:return e}}function on(){let[e,t]=(0,l.useReducer)(an,rn),[n,r]=(0,l.useState)(``),i=e.todos.filter(t=>e.filter===`active`?!t.done:e.filter===`done`?t.done:!0);return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`input`,{className:`demo-input`,value:n,onChange:e=>r(e.target.value),onKeyDown:e=>{e.key===`Enter`&&(t({type:`ADD`,payload:n}),r(``))},placeholder:`Add todo... (Enter)`,style:{flex:1}}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>{t({type:`ADD`,payload:n}),r(``)},children:`Add`})]}),(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[[`all`,`active`,`done`].map(n=>(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{background:e.filter===n?`rgba(97,218,251,0.2)`:void 0,borderColor:e.filter===n?`#61dafb`:void 0},onClick:()=>t({type:`FILTER`,payload:n}),children:n},n)),(0,f.jsxs)(`span`,{className:`demo-label`,children:[e.todos.filter(e=>!e.done).length,` remaining`]})]}),(0,f.jsxs)(`ul`,{className:`demo-list`,children:[i.length===0&&(0,f.jsx)(`li`,{className:`demo-list-item`,style:{color:`#4b5563`,justifyContent:`center`},children:`No todos`}),i.map(e=>(0,f.jsxs)(`li`,{className:`demo-list-item`,children:[(0,f.jsxs)(`span`,{style:{textDecoration:e.done?`line-through`:`none`,color:e.done?`#4b5563`:`#e2e8f0`,cursor:`pointer`,flex:1},onClick:()=>t({type:`TOGGLE`,payload:e.id}),children:[e.done?`✅`:`⬜`,` `,e.text]}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{background:`rgba(248,113,113,0.1)`,borderColor:`rgba(248,113,113,0.3)`,color:`#f87171`},onClick:()=>t({type:`DELETE`,payload:e.id}),children:`Delete`})]},e.id))]})]})}function sn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useReducer`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`จัดการ complex state ด้วย Reducer pattern — เหมือน Redux แต่อยู่ใน component`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useReducer Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🔄`}),(0,f.jsxs)(`span`,{children:[`Pattern: `,(0,f.jsx)(`code`,{children:`dispatch(action)`}),` → `,(0,f.jsx)(`code`,{children:`reducer(currentState, action)`}),` → `,(0,f.jsx)(`code`,{children:`newState`})]})]}),(0,f.jsx)(p,{code:$t})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Todo App — Real World Example`}),(0,f.jsx)(p,{code:en}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Todo Demo — useReducer`}),(0,f.jsx)(on,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useReducer vs useState`}),(0,f.jsx)(p,{code:tn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:nn})]})]})}var cn=`import { useRef } from 'react'
...
}`,un=`import { forwardRef, useImperativeHandle } from 'react'
...
const VideoPlayer = forwardRef((props, ref) => {
  ...
  return <video ref={videoRef} {...props} />
})`,dn=[{q:`useRef กับ useState ต่างกันอย่างไร?`,a:`<strong>useState:</strong> เมื่อ setter ถูกเรียก React จะ re-render component<br>
    ...
    <code>ref</code> กลายเป็น regular prop ได้เลย`}];function fn(){let e=(0,l.useRef)(null),t=(0,l.useRef)(0),[n,r]=(0,l.useState)(``);return t.current++,(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`input`,{ref:e,className:`demo-input`,value:n,onChange:e=>r(e.target.value),placeholder:`Type something...`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>e.current.focus(),children:`Focus`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>r(``),children:`Clear`})]}),(0,f.jsxs)(`div`,{className:`demo-label`,children:[`Render count (via ref, no re-render): `,(0,f.jsx)(`strong`,{style:{color:`#61dafb`},children:t.current})]})]})}function pn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useRef`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`เก็บค่า mutable และ DOM references โดยไม่ trigger re-render`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useRef Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📎`}),(0,f.jsxs)(`span`,{children:[(0,f.jsx)(`code`,{children:`useRef`}),` คือ "กล่อง" ที่เก็บค่า — เปลี่ยนค่าใน `,(0,f.jsx)(`code`,{children:`.current`}),` ได้ตลอดเวลาโดยไม่ทำให้ re-render`]})]}),(0,f.jsx)(p,{code:cn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useRef vs useState`}),(0,f.jsx)(p,{code:ln}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Feature`}),(0,f.jsx)(`th`,{children:`useState`}),(0,f.jsx)(`th`,{children:`useRef`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Triggers re-render`}),(0,f.jsx)(`td`,{children:`✅ Yes`}),(0,f.jsx)(`td`,{children:`❌ No`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Mutable`}),(0,f.jsx)(`td`,{children:`No (use setter)`}),(0,f.jsx)(`td`,{children:`✅ Yes (.current)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`DOM access`}),(0,f.jsx)(`td`,{children:`❌ No`}),(0,f.jsx)(`td`,{children:`✅ Yes`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Persists across renders`}),(0,f.jsx)(`td`,{children:`✅ Yes`}),(0,f.jsx)(`td`,{children:`✅ Yes`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`DOM Ref + Render Counter`}),(0,f.jsx)(fn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`forwardRef & useImperativeHandle`}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🆕`}),(0,f.jsxs)(`span`,{children:[`React 19: `,(0,f.jsx)(`code`,{children:`forwardRef`}),` ไม่จำเป็นแล้ว! สามารถส่ง `,(0,f.jsx)(`code`,{children:`ref`}),` เป็น regular prop ได้เลย`]})]}),(0,f.jsx)(p,{code:un})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:dn})]})]})}var mn=[{id:`home`,label:`หน้าหลัก`,icon:`🏠`},{section:`พื้นฐาน`},{id:`jsx`,label:`JSX & Components`,icon:`⚛️`},{id:`props`,label:`Props & State`,icon:`📦`},{section:`Hooks`},{id:`useeffect`,label:`useEffect`,icon:`🎣`},{id:`usecontext`,label:`useContext`,icon:`🔗`},{id:`useref`,label:`useRef`,icon:`📎`},{id:`memo`,label:`useMemo & useCallback`,icon:`⚡`},{id:`usereducer`,label:`useReducer`,icon:`🔄`},{section:`Advanced`},{id:`customhooks`,label:`Custom Hooks`,icon:`🪝`},{id:`react19`,label:`React 19 Features`,icon:`🚀`},{section:`JavaScript`},{id:`array`,label:`Array Methods`,icon:`📋`},{section:`Backend`},{id:`nodejs`,label:`Node.js`,icon:`🟩`},{section:`Database`},{id:`sql`,label:`SQL`,icon:`🗄️`},{section:`TypeScript`},{id:`typescript`,label:`TypeScript`,icon:`📘`},{section:`DevOps`},{id:`builddeploy`,label:`Build → Deploy → Browser`,icon:`🚢`},{id:`docker`,label:`Docker`,icon:`🐳`},{section:`สัมภาษณ์`},{id:`interview`,label:`Interview Q&A`,icon:`❓`}],hn={home:Ee,jsx:Fe,props:Ze,useeffect:Qt,usecontext:Gt,useref:pn,memo:Ue,usereducer:sn,customhooks:de,react19:at,array:x,nodejs:A,sql:_t,builddeploy:ae,typescript:It,docker:we,interview:Oe};function gn(){let[e,t]=(0,l.useState)(`home`),n=e=>{t(e),window.scrollTo(0,0)},r=hn[e]||Ee;return(0,f.jsxs)(`div`,{className:`app`,children:[(0,f.jsxs)(`aside`,{className:`sidebar`,children:[(0,f.jsxs)(`div`,{className:`sidebar-header`,children:[(0,f.jsxs)(`div`,{className:`sidebar-title`,children:[(0,f.jsx)(`span`,{children:`⚛️`}),` React Interview`]}),(0,f.jsx)(`div`,{className:`sidebar-subtitle`,children:`Welcome to Basic Web Developer Prep · React`})]}),(0,f.jsx)(`nav`,{className:`sidebar-nav`,children:mn.map((t,r)=>t.section?(0,f.jsx)(`div`,{className:`nav-section-label`,children:t.section},r):(0,f.jsxs)(`div`,{className:`nav-item ${e===t.id?`active`:``}`,onClick:()=>n(t.id),children:[(0,f.jsx)(`span`,{className:`nav-icon`,children:t.icon}),(0,f.jsx)(`span`,{children:t.label})]},t.id))})]}),(0,f.jsx)(`main`,{className:`main-content`,children:(0,f.jsx)(r,{onNavigate:n})})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(gn,{})}));