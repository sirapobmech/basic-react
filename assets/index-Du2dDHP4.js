...
dist/assets/index-D4uMfRRk.css  ← CSS ทั้งหมดรวมกัน`,ne=`// Minify — ลบ space, comment, ย่อชื่อตัวแปร
// ก่อน
...
// ผลลัพธ์
// index.js 2MB → หลัง optimize → 200KB`,re=`// โครงสร้าง dist/ หลัง build
dist/
...
// ถ้า code เหมือนเดิม → hash เหมือนเดิม → browser ใช้ cache ได้เลย`,ie=`<!-- dist/index.html — สิ่งที่ browser ได้รับ -->
<html>
  <head>
...
</html>`,C=`// React รัน App() และได้ Virtual DOM
...
function useHelper() {
  ...
  return value
}`,ce=`// Custom Hook: useLocalStorage
...
}`,de=[{q:`Custom Hook คืออะไร และต้องตั้งชื่ออย่างไร?`,a:`Custom Hook คือ JavaScript function ที่:<br>
...
# Container  = อาหารที่กำลังเสิร์ฟอยู่`,me=`# ==================== Stage 1: Build ====================
...
# แค่ documentation — ต้องใช้ -p ตอน run`,he=`# .dockerignore — บอก Docker ว่าอย่า copy อะไรเข้า container
...
*.md           # README ไม่จำเป็น
.env           # ไม่ควร copy secret เข้า image!`,E=`# ==================== Image ====================
...
docker exec -it <container_id> sh`,D=`# Port Mapping — เชื่อม port เครื่องเรากับ container
...
# แต่ละตัวใช้ port 80 ใน container — ไม่ชนกัน!`,ge=`# docker-compose.yml — รันหลาย container พร้อมกัน
...
volumes:
  db_data:                     # named volume`,_e=`# คำสั่ง Docker Compose
...
docker compose ps          # ดูสถานะทุก container`,ve=`# Volume — เก็บข้อมูลถาวร
...
# ลบ volume
docker volume rm db_data`,ye=`# CI/CD Flow กับ Docker
...
# docker pull my-app
# docker run -p 80:80 my-app`,be=[{q:`Docker คืออะไร แก้ปัญหาอะไร?`,a:`Docker คือ platform สำหรับ package และ run application ใน container<br><br>
    ปัญหาที่แก้:<br>
    ...
    • <code>.env</code> — ห้าม copy secret เข้า image เด็ดขาด!`}],xe=`# ขั้นตอนที่ 1: docker build -t interview-react .
...
Step 8: COPY --from=builder /app/dist /usr/share/nginx/html
  → copy เฉพาะ dist/ มาใส่ nginx`,Se=`# Image ที่ได้หลัง build เสร็จ
...
# ไม่มี: src/, node_modules/, package.json`,Ce=`# ขั้นตอนที่ 2: docker run -p 8080:80 interview-react
...
a1b2c3d4e5f6   interview-react   Up 5 minutes  0.0.0.0:8080->80/tcp`,we=`# เปิด Browser localhost:8080 — เกิดอะไรขึ้น?
...
const element = React.createElement(
  ...
  { className: 'title' },
  'Hello World'
)`,je=`// Function Component (แนะนำ - modern React)
...
}`,Me=`// Fragment ใช้เมื่อต้องการ return หลาย element
...
}`,Ne=`function UserStatus({ isLoggedIn, username }) {
  return (
    <div>
      {/* Ternary operator */}
      {isLoggedIn ? (
...
const name = "React"
return <h1>Hello {name.toUpperCase()}!</h1>`,Fe=[{q:`JSX คืออะไร และทำไม React ถึงใช้ JSX?`,a:`JSX (JavaScript XML) คือ syntax extension ที่ทำให้เราเขียน HTML-like syntax ใน JavaScript ได้
    <br><br>
    ...
    ถ้าต้องการ <code>key</code> prop ต้องใช้ <code>React.Fragment</code> ยาว`}];function Ie(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Fundamentals`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`JSX & Components`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`พื้นฐานของ React: JSX syntax, การสร้าง Component, และกฎต่างๆ ที่ต้องรู้`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JSX คืออะไร?`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚛️`}),(0,f.jsxs)(`span`,{children:[`JSX ถูก compile โดย Babel เป็น `,(0,f.jsx)(`code`,{children:`React.createElement()`}),` — ไม่ใช่ HTML และไม่ใช่ string`]})]}),(0,f.jsx)(p,{code:Ae})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Function Components`}),(0,f.jsx)(p,{code:je}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`✅`}),(0,f.jsx)(`span`,{children:`ใช้ Function Component เสมอในโปรเจกต์ใหม่ — ทำงานได้ดีกับ Hooks และอ่านง่ายกว่า Class Component`})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Fragments`}),(0,f.jsx)(p,{code:Me})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Conditional Rendering`}),(0,f.jsx)(p,{code:Ne})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JSX Rules ที่ต้องจำ`}),(0,f.jsx)(p,{code:Pe})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Fe})]})]})}var Le=`import { memo } from 'react'
...
}`,ze=`import { useCallback } from 'react'
...
const MemoChild = memo(function Child({ onAdd, onRemove }) {
  ...
  return <div>...</div>
})`,Be=`// เมื่อไหรควรใช้ useMemo / useCallback?
...
// ในอนาคต อาจไม่ต้องเขียน useMemo/useCallback เองอีกต่อไป`,Ve=[{q:`useMemo กับ useCallback ต่างกันอย่างไร?`,a:`<code>useMemo</code> — memoize <strong>value</strong> (ผลลัพธ์ของ function)<br>
    ...
    และใน React 19 React Compiler จะ optimize ให้อัตโนมัติ`}],He=(0,l.memo)(function({onIncrement:e}){return(0,l.useMemo)(()=>{let e=0;return()=>++e},[]),(0,f.jsxs)(`div`,{style:{padding:`12px 16px`,background:`#1e2535`,borderRadius:8,fontSize:13,color:`#9ca3af`,marginTop:10},children:[(0,f.jsx)(`span`,{style:{color:`#4ade80`},children:`MemoChild`}),` (ไม่ re-render เมื่อ parent count เปลี่ยน)`,(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{marginLeft:12},onClick:e,children:`Add Item`})]})});function Ue(){let[e,t]=(0,l.useState)(0),[n,r]=(0,l.useState)([]),i=(0,l.useCallback)(()=>{r(e=>[...e,`Item ${e.length+1}`])},[]);return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsx)(`div`,{className:`demo-row`,children:(0,f.jsxs)(`button`,{className:`demo-btn`,onClick:()=>t(e=>e+1),children:[`Re-render Parent (`,e,`)`]})}),(0,f.jsx)(He,{onIncrement:i}),n.length>0&&(0,f.jsx)(`ul`,{className:`demo-list`,style:{marginTop:8},children:n.map((e,t)=>(0,f.jsx)(`li`,{className:`demo-list-item`,style:{padding:`6px 12px`},children:e},t))})]})}function We(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Performance`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useMemo & useCallback`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`Memoization เพื่อลด unnecessary re-renders และ expensive calculations`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`React.memo — Component Memoization`}),(0,f.jsx)(p,{code:Le})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useMemo — Value Memoization`}),(0,f.jsx)(p,{code:Re})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useCallback — Function Memoization`}),(0,f.jsx)(p,{code:ze})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`memo + useCallback Demo`}),(0,f.jsx)(Ue,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`เมื่อไหรควรใช้?`}),(0,f.jsx)(p,{code:Be}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🚀`}),(0,f.jsxs)(`span`,{children:[`React 19 มี `,(0,f.jsx)(`strong`,{children:`React Compiler`}),` ที่ memoize code อัตโนมัติ — ในอนาคตอาจไม่ต้องเขียน useMemo/useCallback เองเลย`]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Ve})]})]})}var Ge=`// Props คือ read-only data ที่ส่งจาก parent ไป child
...
}`,qe=`// React 18+ batches multiple setState calls automatically!
...
}`,Je=`// Lifting State Up - เมื่อหลาย Component ต้องใช้ state เดียวกัน
...
function ItemList({ selectedId, onSelect }) {
  return items.map(item => (
...
}`,Ye=[{q:`Props และ State ต่างกันอย่างไร?`,a:`<strong>Props:</strong><br>
    ...
    • เหมาะกับ file input หรือกรณีที่ไม่ต้องการ validation`}];function Xe(){let[e,t]=(0,l.useState)(0);return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,children:[(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>t(e=>e-1),children:`−`}),(0,f.jsx)(`span`,{className:`demo-value`,children:e}),(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>t(e=>e+1),children:`+`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>t(0),children:`Reset`})]}),(0,f.jsx)(`p`,{className:`demo-label`,style:{marginTop:12},children:e===0?`Start counting!`:e>0?`Positive: ${e}`:`Negative: ${e}`})]})}function Ze(){let[e,t]=(0,l.useState)({name:``,email:``});return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`span`,{className:`demo-label`,children:`Name:`}),(0,f.jsx)(`input`,{className:`demo-input`,value:e.name,onChange:e=>t(t=>({...t,name:e.target.value})),placeholder:`กรอกชื่อ...`})]}),(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`span`,{className:`demo-label`,children:`Email:`}),(0,f.jsx)(`input`,{className:`demo-input`,value:e.email,onChange:e=>t(t=>({...t,email:e.target.value})),placeholder:`กรอก email...`})]}),(0,f.jsx)(`div`,{className:`demo-output`,children:e.name||e.email?`👤 ${e.name||`...`} | 📧 ${e.email||`...`}`:`กรอกข้อมูลเพื่อดูผลลัพธ์`})]})}function Qe(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Core Concepts`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`Props & State`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`การส่งข้อมูลระหว่าง component ด้วย Props และการจัดการ state ด้วย useState`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Props — การส่งข้อมูล`}),(0,f.jsx)(p,{code:Ge})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useState Hook`}),(0,f.jsx)(p,{code:Ke}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Counter Demo — useState`}),(0,f.jsx)(Xe,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Controlled Form Demo`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📝`}),(0,f.jsx)(`span`,{children:`Controlled Component: React state เป็น single source of truth ของ input`})]}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Form Demo — Controlled Component`}),(0,f.jsx)(Ze,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`State Batching (React 18+)`}),(0,f.jsx)(p,{code:qe}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚡`}),(0,f.jsx)(`span`,{children:`React 18+ batch setState calls ทั้งใน event handlers, async functions, setTimeout, และ Promise — ลด re-renders โดยอัตโนมัติ`})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Lifting State Up`}),(0,f.jsx)(p,{code:Je})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Ye})]})]})}var $e=`// React 19: use() Hook
...
}`,et=`// React 19: Actions — Form handling แบบใหม่
...
}`,tt=`// React 19: useOptimistic — Optimistic UI Updates
...
}`,nt=`// React 19: React Compiler (Beta)
...
}`,rt=`// React 19: ref เป็น regular prop แล้ว!
...
function App() {
  ...
  return <Input ref={ref} placeholder="Hello" />
}`,it=[{q:`React 19 มีอะไรใหม่ที่สำคัญบ้าง?`,a:`<strong>1. use() Hook:</strong> ใช้แทน useEffect+useState สำหรับ async data และ Context<br>
    ...
    React จะ render urgent updates (typing) ก่อน แล้วค่อย render transition updates`}];function at(){let[e,t]=(0,l.useState)(`A`),[n,r]=(0,l.useTransition)();return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:12},children:[[`A`,`B`,`C`].map(i=>(0,f.jsxs)(`button`,{className:`demo-btn-sm`,style:{background:e===i?`rgba(97,218,251,0.2)`:void 0,borderColor:e===i?`#61dafb`:void 0,opacity:n?.6:1},onClick:()=>r(()=>t(i)),children:[`Tab `,i]},i)),n&&(0,f.jsx)(`span`,{className:`demo-label`,children:`🔄 Loading...`})]}),(0,f.jsxs)(`div`,{className:`demo-output`,children:[`Tab `,e,` content — startTransition ป้องกัน UI ค้างระหว่าง switch`]})]})}function ot(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`React 19`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`React 19 New Features`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ฟีเจอร์ใหม่ใน React 19 ที่ต้องรู้สำหรับ Frontend Developer ในปี 2025-2026`})]}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🆕`}),(0,f.jsx)(`span`,{children:`Project นี้ใช้ React 19.2.6 — ฟีเจอร์ใหม่ทั้งหมดนี้พร้อมใช้งานได้เลย!`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`use() Hook`}),(0,f.jsx)(p,{code:$e})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Actions & useActionState`}),(0,f.jsx)(p,{code:et})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useOptimistic — Optimistic UI`}),(0,f.jsx)(p,{code:tt}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚡`}),(0,f.jsx)(`span`,{children:`useOptimistic ทำให้ UI ตอบสนองทันที แล้วค่อย sync กับ server — ถ้า server error จะ revert อัตโนมัติ`})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useTransition — Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`useTransition Demo`}),(0,f.jsx)(at,{})]}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`ℹ️`}),(0,f.jsx)(`span`,{children:`useTransition ให้ React รู้ว่า update นี้ไม่ urgent — React จะ render urgent updates (เช่น typing) ก่อนเสมอ`})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`ref as Regular Prop`}),(0,f.jsx)(p,{code:rt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`React Compiler — Auto Memoization`}),(0,f.jsx)(p,{code:nt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:it})]})]})}var st=`CREATE TABLE users (
  id       INT PRIMARY KEY,
  name     VARCHAR(100),
  email    VARCHAR(100),
  age      INT,
...
DELETE FROM orders
WHERE created_at < '2023-01-01' AND amount < 100;`,lt=`-- Database Relationship — ความสัมพันธ์ระหว่างตาราง
...
WHERE sc.student_id = 1;`,ut=`-- N+1 Problem — query เกินความจำเป็น เกิดบ่อยมากกับ ORM
...
SELECT * FROM users WHERE dept_id IS NULL;`,ft=`-- ORDER BY เรียงผลลัพธ์
...
SELECT * FROM users
ORDER BY id
LIMIT 10 OFFSET 20;  -- แถวที่ 21-30`,pt=`--  ตาราง users          ตาราง departments
--  +---------+-------+   +----+-----------+
...
-- ผล: Alice-Engineer, Bob-Marketing, NULL-HR`,mt=`-- Aggregate Functions — คำนวณจากหลายแถว
...
SELECT MAX(amount) FROM orders;  -- มากสุด`,ht=`-- GROUP BY จัดกลุ่มแถวที่ค่าเท่ากันไว้ด้วยกัน
...
-- ⚠️ ลำดับการทำงาน SQL
-- FROM → WHERE → GROUP BY → HAVING → SELECT → ORDER BY → LIMIT`,gt=`-- Subquery คือ query ที่ซ้อนอยู่ใน query อื่น
...
);`,O=`-- CTE (Common Table Expression) คือการตั้งชื่อ query ชั่วคราว
...
FROM users u
JOIN high_spenders hs ON u.id = hs.user_id;`,_t=`-- Window Function คำนวณโดยไม่ยุบแถว
...
FROM orders;`,vt=`-- Index คือโครงสร้างข้อมูลพิเศษที่ทำให้ค้นหาเร็วขึ้น
...
EXPLAIN SELECT * FROM users WHERE email = 'alice@test.com';`,yt=`-- Transaction คือการรวมหลาย query ให้เป็นหน่วยเดียว
...
ROLLBACK;  -- ยกเลิกทุกอย่าง → เงิน A ไม่หายไป`,bt=`-- ความแตกต่างที่เจอบ่อย
...
-- SQLite
SELECT datetime('now');
SELECT date('now');`,xt=`-- SQL Injection คือการที่ hacker แทรก SQL เข้ามาใน query
...
prisma.user.findUnique({ where: { email } })  // ✅ ปลอดภัยเสมอ`,St=`// เชื่อม Node.js กับแต่ละ Database
...
const users = await prisma.user.findMany()  // code ไม่เปลี่ยน`,Ct=[{q:`WHERE กับ HAVING ต่างกันอย่างไร?`,a:`ทั้งคู่ใช้กรองข้อมูล แต่ทำงานคนละช่วง<br><br>
    ...
    แนะนำ: ใช้ CTE แทน subquery ซ้อนเกิน 1 ชั้น ทีมอ่านง่ายกว่ามาก`}];function wt(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Database`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`SQL`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน SQL ตั้งแต่พื้นฐานจนถึงขั้นสูง พร้อม pattern ที่เจอในการสัมภาษณ์งาน`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Schema ตัวอย่าง`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`ใช้ 3 ตารางนี้เป็น reference ตลอดหน้า — `,(0,f.jsx)(`code`,{children:`users`}),` เชื่อมกับ `,(0,f.jsx)(`code`,{children:`departments`}),` ผ่าน `,(0,f.jsx)(`code`,{children:`dept_id`}),` และเชื่อมกับ `,(0,f.jsx)(`code`,{children:`orders`}),` ผ่าน `,(0,f.jsx)(`code`,{children:`user_id`})]}),(0,f.jsx)(p,{code:st,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`INSERT / UPDATE / DELETE`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`DML (Data Manipulation Language) — คำสั่งจัดการข้อมูลในตาราง ต้องระวัง UPDATE และ DELETE ที่ไม่มี WHERE จะกระทบทุกแถวในตาราง`}),(0,f.jsx)(p,{code:ct,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Database Relationship`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ความสัมพันธ์ระหว่างตารางมี 2 แบบหลัก — One-to-Many ใช้ Foreign Key, Many-to-Many ต้องมี Junction Table กลาง`}),(0,f.jsx)(p,{code:lt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`N+1 Problem`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`N+1 เกิดเมื่อ query ข้อมูล N รายการ แล้ว loop ดึงข้อมูลอีก N ครั้ง รวมเป็น N+1 queries — แก้ด้วย JOIN หรือ `,(0,f.jsx)(`code`,{children:`include`}),` ใน Prisma`]}),(0,f.jsxs)(`div`,{className:`callout callout-warning`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚠️`}),(0,f.jsx)(`span`,{children:`N+1 เป็นปัญหาที่ถามบ่อยในสัมภาษณ์ fullstack และเป็นสาเหตุหลักที่ทำให้ API ช้าโดยไม่รู้ตัว`})]}),(0,f.jsx)(p,{code:ut,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`SELECT / WHERE`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`SELECT`}),` เลือกคอลัมน์, `,(0,f.jsx)(`code`,{children:`WHERE`}),` กรองแถวตามเงื่อนไข — ใช้ `,(0,f.jsx)(`code`,{children:`LIKE`}),` สำหรับ pattern matching และ `,(0,f.jsx)(`code`,{children:`IS NULL`}),` ตรวจค่าว่าง (ใช้ `,(0,f.jsx)(`code`,{children:`= NULL`}),` ไม่ได้)`]}),(0,f.jsx)(p,{code:dt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`ORDER BY / LIMIT / DISTINCT`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`ORDER BY`}),` เรียงผลลัพธ์, `,(0,f.jsx)(`code`,{children:`LIMIT`}),` + `,(0,f.jsx)(`code`,{children:`OFFSET`}),` ใช้ทำ pagination — หน้าที่ n ใช้ `,(0,f.jsx)(`code`,{children:`OFFSET (n-1) * pageSize`})]}),(0,f.jsx)(p,{code:ft,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JOIN`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`JOIN ใช้ดึงข้อมูลจากหลายตารางมารวมกัน โดยระบุเงื่อนไขการเชื่อม (`,(0,f.jsx)(`code`,{children:`ON`}),`) — ประเภทของ JOIN กำหนดว่าจะเอาแถวไหนบ้างเมื่อไม่มี match`]}),(0,f.jsx)(p,{code:pt,lang:`sql`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`JOIN`}),(0,f.jsx)(`th`,{children:`คืนอะไร`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`INNER JOIN`}),(0,f.jsx)(`td`,{children:`เฉพาะแถวที่ match ทั้งสองฝั่ง`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`LEFT JOIN`}),(0,f.jsx)(`td`,{children:`ทุกแถวจากซ้าย + match จากขวา (NULL ถ้าไม่มี)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`RIGHT JOIN`}),(0,f.jsx)(`td`,{children:`ทุกแถวจากขวา + match จากซ้าย (NULL ถ้าไม่มี)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`FULL OUTER JOIN`}),(0,f.jsx)(`td`,{children:`ทุกแถวทั้งสองฝั่ง (NULL ถ้าไม่มี match)`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Aggregate Functions`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Aggregate function คำนวณค่าจากหลายแถวให้เป็นค่าเดียว เช่น รวม นับ หาค่าเฉลี่ย — มักใช้คู่กับ `,(0,f.jsx)(`code`,{children:`GROUP BY`})]}),(0,f.jsx)(p,{code:mt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`GROUP BY / HAVING`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`GROUP BY`}),` จัดกลุ่มแถวที่ค่าคอลัมน์เหมือนกันไว้ด้วยกัน แล้ว aggregate แต่ละกลุ่ม — `,(0,f.jsx)(`code`,{children:`HAVING`}),` ใช้กรองกลุ่มหลัง GROUP BY (ต่างจาก WHERE ที่กรองก่อน)`]}),(0,f.jsx)(p,{code:ht,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Subquery`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Subquery คือ query ซ้อนใน query — ผลของ subquery ถูกใช้เป็น input ให้ outer query ใช้ใน WHERE, FROM, หรือ SELECT ก็ได้`}),(0,f.jsx)(p,{code:gt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`CTE — WITH clause`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`CTE คือการตั้งชื่อให้ query ชั่วคราว ทำให้อ่านง่ายกว่า subquery ซ้อนหลายชั้น — ผลของ CTE จะถูก reuse ได้ใน query เดียวกัน`}),(0,f.jsx)(p,{code:O,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Window Functions`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Window Function คำนวณค่าโดยพิจารณา "หน้าต่าง" ของแถวรอบข้าง (`,(0,f.jsx)(`code`,{children:`OVER`}),`) — ต่างจาก GROUP BY ตรงที่ไม่ยุบแถว ทุกแถวยังอยู่ครบ`]}),(0,f.jsx)(p,{code:_t,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Index`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Index คือโครงสร้างข้อมูลพิเศษที่สร้างขึ้นมาเพิ่มเติม ช่วยให้ DB กระโดดไปหาแถวที่ต้องการได้โดยตรง ไม่ต้องอ่านทุกแถว — แต่ทำให้ write ช้าลงเล็กน้อยเพราะต้อง update index ด้วย`}),(0,f.jsx)(p,{code:vt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Transaction & ACID`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Transaction รวม query หลายตัวให้เป็นหน่วยเดียว — ถ้า query ใดล้มเหลว ทุกอย่างถูกยกเลิก (ROLLBACK) ป้องกันข้อมูลค้างกลางๆ ระหว่างการทำงาน`}),(0,f.jsx)(p,{code:yt,lang:`sql`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`ACID`}),(0,f.jsx)(`th`,{children:`หมายถึง`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Atomicity`}),(0,f.jsx)(`td`,{children:`ทำครบหรือไม่ทำเลย ไม่มีครึ่งๆ กลางๆ`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Consistency`}),(0,f.jsx)(`td`,{children:`ข้อมูลถูกต้องตาม constraint ก่อนและหลัง transaction`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Isolation`}),(0,f.jsx)(`td`,{children:`หลาย transaction รันพร้อมกันต้องไม่กระทบกัน`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Durability`}),(0,f.jsx)(`td`,{children:`COMMIT แล้วข้อมูลถาวร แม้ระบบล่ม`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`SQL ยอดนิยมในปัจจุบัน`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`SQL ที่นิยมในตลาดงานมี 4 ตัวหลัก แต่ละตัวเหมาะกับงานต่างกัน syntax ส่วนใหญ่เหมือนกัน มีต่างกันแค่บางส่วน`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Database`}),(0,f.jsx)(`th`,{children:`เหมาะกับ`}),(0,f.jsx)(`th`,{children:`นิยมใช้กับ`}),(0,f.jsx)(`th`,{children:`ข้อเด่น`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:`PostgreSQL`})}),(0,f.jsx)(`td`,{children:`Web app, Data ซับซ้อน`}),(0,f.jsx)(`td`,{children:`Node.js, Python, Rails`}),(0,f.jsx)(`td`,{children:`Feature ครบ, JSON support, open source`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:`MySQL`})}),(0,f.jsx)(`td`,{children:`Web app ทั่วไป`}),(0,f.jsx)(`td`,{children:`PHP, WordPress, Laravel`}),(0,f.jsx)(`td`,{children:`เร็ว, ใช้งานง่าย, host ราคาถูก`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:`SQLite`})}),(0,f.jsx)(`td`,{children:`App เล็ก, Mobile, Testing`}),(0,f.jsx)(`td`,{children:`React Native, Electron`}),(0,f.jsx)(`td`,{children:`ไม่ต้องติดตั้ง server, เก็บเป็นไฟล์เดียว`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:`SQL Server`})}),(0,f.jsx)(`td`,{children:`Enterprise, .NET`}),(0,f.jsx)(`td`,{children:`C#, .NET, Azure`}),(0,f.jsx)(`td`,{children:`integrate กับ Microsoft stack ได้ดี`})]})]})]}),(0,f.jsxs)(`div`,{className:`callout callout-info`,style:{marginTop:`16px`},children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsxs)(`span`,{children:[`ตลาดงาน Node.js ส่วนใหญ่ใช้ `,(0,f.jsx)(`strong`,{children:`PostgreSQL`}),` — ถ้าเรียนได้ตัวเดียวให้เรียน PostgreSQL ก่อน`]})]}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Syntax ที่ต่างกัน`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`SQL มาตรฐาน (SELECT, JOIN, GROUP BY) เหมือนกันทุก database ที่ต่างคือ syntax เฉพาะตัว เช่น auto increment, date function, string concat`}),(0,f.jsx)(p,{code:bt,lang:`sql`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`เชื่อมกับ Node.js`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`แต่ละ database ใช้ library ต่างกัน แต่ถ้าใช้ Prisma เขียน code เหมือนกันหมด แค่เปลี่ยน provider ใน schema`}),(0,f.jsx)(p,{code:St,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`SQL Injection — ช่องโหว่ที่ต้องระวัง`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`SQL Injection คือการที่ hacker แทรก SQL เข้าไปใน query ผ่าน input ของ user แก้ได้ด้วยการใช้ placeholder (`,(0,f.jsx)(`code`,{children:`$1`}),`, `,(0,f.jsx)(`code`,{children:`?`}),`) แทนการต่อ string ตรงๆ`]}),(0,f.jsxs)(`div`,{className:`callout callout-warning`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚠️`}),(0,f.jsx)(`span`,{children:`ห้ามนำ input จาก user ต่อลงใน SQL string โดยตรงเด็ดขาด ให้ใช้ placeholder หรือ ORM เสมอ`})]}),(0,f.jsx)(p,{code:xt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Ct})]})]})}var Tt=`// Node.js คือ JavaScript runtime บน server
...
server.listen(3000)
// เปิด browser ไปที่ localhost:3000 → เห็น Hello World`,Et=`// ❌ Blocking — PHP / Python แบบดั้งเดิม
...
console.log(data)
// ระหว่าง 500ms นั้น request อื่นเข้ามาก็ต้องค้างรอหมด`,Dt=`// ✅ Non-blocking — Node.js
...
// 3. อ่านไฟล์เสร็จแล้ว  ← มาทีหลัง`,Ot=`// async/await — เขียนง่ายกว่า callback แต่ยัง non-blocking
...
// ไม่ได้ยืนรอครัวทำอาหารโต๊ะ 1 เสร็จก่อน`,kt=`// Express — framework ยอดนิยมสำหรับทำ API
...
app.listen(3000, () => console.log('Server running on port 3000'))`,At=`// REST API — มาตรฐานการออกแบบ API
...
500 Server Error → server พัง`,jt=`// Middleware — function ที่ทำงานระหว่าง request → response
...
})`,Mt=`// Router — แยก route ออกเป็นไฟล์ย่อย
...
app.use('/orders', orderRouter)  // /orders, /orders/:id`,Nt=`// Error Handling
...
})`,Pt=`// Environment Variables — ค่าที่ต่างกันในแต่ละ env
...
// ✅ deploy บน server ต่างๆ ใช้ค่าต่างกันได้`,Ft=`// JWT Authentication — ระบบ login ที่นิยมที่สุด
...
// npx prisma generate                  ← generate Prisma Client`,Lt=`// prisma.js — สร้าง instance เดียวใช้ทั้งโปรเจกต์
...
const total = await prisma.user.count({
  where: { role: 'user' }
})`,Rt=`// Helmet — ตั้งค่า HTTP Security Headers อัตโนมัติ
// npm install helmet
...
app.use(cors({ ... }))
app.use(express.json())
// ... routes`,zt=`// Refresh Token — แก้ปัญหา JWT หมดอายุกลางคัน
...
})`,Bt=`// Testing — ทดสอบ API ด้วย Jest + Supertest
...
})`,Vt=`// CORS — อนุญาตให้ frontend domain อื่นเรียก API ได้
...
// CORS คือการบอก browser ว่า "origin นี้ไว้ใจได้"`,Ht=`// Input Validation ด้วย Zod — ตรวจข้อมูลก่อนเข้า DB
import { z } from 'zod'
...
app.patch('/users/:id', validate(updateUserSchema), updateUser)`,Ut=`// Logging — บันทึก request และ error
...
})`,Wt=`// Authentication — ตรวจว่าคุณเป็นใคร
...
// → 403 Forbidden`,Kt=`// Caching ด้วย Redis — อย่าดึงข้อมูลเดิมซ้ำทุก request
...
})`,qt=`// Rate Limiting — จำกัดจำนวน request ต่อ IP
...
// ถ้าเกิน limit — ได้รับ 429 Too Many Requests กลับมา`,Jt=`// db.js — ตั้งค่า Pool ครั้งเดียวตอนเริ่ม server
import pg from 'pg'
...
// ไม่ต้องเปิด/ปิด connection เอง Pool จัดการให้`,Yt=`// controllers/productController.js — raw SQL (pg)
...
}`,Xt=`// controllers/productController.js — Prisma
import { prisma } from '../prisma.js'
...
import { PrismaClient } from '@prisma/client'
export const prisma = new PrismaClient()`,Zt=`// ❌ รอทีละอัน — 330ms
...
const [user, orders, reviews] = await Promise.all([
  ...
  prisma.review.findMany({ where: { userId: id } }),
])`,Qt=[{q:`Node.js คืออะไร ต่างจาก Browser JavaScript ยังไง?`,a:`Node.js คือ JavaScript runtime บน server — ทำให้ JS รันนอก browser ได้<br><br>
    ...
    ในทางปฏิบัติส่วนใหญ่ใช้ PATCH เพราะ flexible กว่า`}];function $t(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Backend`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`Node.js Backend`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน Node.js และ Express สำหรับทำ REST API พร้อม pattern ที่ใช้จริงในงาน`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Node.js คืออะไร`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Node.js คือ JavaScript runtime ที่ทำให้ JS รันบน server ได้ ก่อนหน้านี้ JS รันได้แค่ใน browser เท่านั้น`}),(0,f.jsx)(p,{code:Tt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Event Loop — Non-blocking I/O`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Node.js รัน thread เดียว แต่รับ request พร้อมกันได้เยอะ เพราะงาน I/O (อ่านไฟล์, query DB, เรียก API) จะถูกส่งให้ OS ทำแทน Node.js ไม่รอ — วิ่งรับ request ถัดไปได้เลย`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`ปัญหาของ Blocking`}),(0,f.jsx)(p,{code:Et,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Non-blocking แก้ยังไง`}),(0,f.jsx)(p,{code:Dt,lang:`javascript`}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsxs)(`span`,{children:[`สังเกตว่า output ไม่ได้เรียงตามลำดับที่เขียน — เพราะ Node.js ไม่รอ `,(0,f.jsx)(`code`,{children:`readFile`}),` แต่วิ่งต่อไปก่อน แล้วค่อยกลับมารัน callback ทีหลังเมื่อเสร็จ`]})]}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`async/await — เขียนง่ายขึ้น`}),(0,f.jsx)(p,{code:Ot,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Event Loop ภาพรวม`}),(0,f.jsx)(p,{code:k,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Express — ทำ API`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Express คือ framework ยอดนิยมของ Node.js สำหรับทำ web server และ API ให้โครงสร้าง routing และ middleware ที่ใช้งานง่าย`}),(0,f.jsx)(p,{code:kt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`REST API Design`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`REST คือมาตรฐานการออกแบบ API โดยใช้ HTTP Method บอกว่าจะทำอะไร และ URL บอกว่าทำกับอะไร — ทำให้ API อ่านง่ายและคาดเดาได้`}),(0,f.jsx)(p,{code:At,lang:`bash`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Middleware`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Middleware คือ function ที่ทำงานระหว่าง request เข้ามาและ response ออกไป ทุก request ผ่าน middleware ตามลำดับก่อนถึง route handler`}),(0,f.jsx)(p,{code:jt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Prisma ORM`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Prisma คือ ORM ยอดนิยมของ Node.js — แทน raw SQL ด้วย TypeScript-friendly API มี schema ที่อ่านง่าย, auto-generate migration, และ type-safe query`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Setup & Schema`}),(0,f.jsx)(p,{code:It,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`CRUD Operations`}),(0,f.jsx)(p,{code:Lt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Helmet — Security Headers`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Helmet ตั้งค่า HTTP header ที่เกี่ยวกับความปลอดภัยให้อัตโนมัติ ป้องกัน XSS, Clickjacking, และช่องโหว่พื้นฐานด้วยบรรทัดเดียว`}),(0,f.jsx)(p,{code:Rt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`CORS`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`CORS คือการบอก browser ว่า frontend domain ไหนเรียก API นี้ได้บ้าง ถ้าไม่ตั้งค่า browser จะบล็อก request จาก frontend ทันที แม้ API ทำงานได้ปกติ`}),(0,f.jsx)(p,{code:Vt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Input Validation — Zod`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ตรวจข้อมูลที่ user ส่งมาก่อนนำเข้า DB เสมอ — ป้องกันข้อมูลผิด type, ค่าว่าง, หรือ format ผิด Zod เป็น library ยอดนิยมที่ตรวจ type และ validate พร้อมกันในขั้นตอนเดียว`}),(0,f.jsx)(p,{code:Ht,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Logging — Morgan & Winston`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Morgan บันทึก HTTP request ทุกอันอัตโนมัติ — Winston บันทึก event ภายใน app ใช้ทั้งคู่เพื่อ debug และ monitor ปัญหาใน production โดยไม่ต้องเดา`}),(0,f.jsx)(p,{code:Ut,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Router — แยกไฟล์`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`เมื่อโปรเจกต์ใหญ่ขึ้น ควรแยก route ออกเป็นไฟล์ย่อยตาม resource ทำให้ code อ่านง่ายและจัดการได้ง่ายขึ้น`}),(0,f.jsx)(p,{code:Mt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Error Handling`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ทุก async route ต้องมี try/catch และส่ง error ไปให้ error handler middleware Express มี error handler พิเศษที่รับ 4 parameter (err, req, res, next)`}),(0,f.jsx)(p,{code:Nt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Environment Variables`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ค่าที่ต่างกันในแต่ละ environment เช่น DB URL, API key, password ต้องเก็บใน .env ไม่ใส่ตรงๆ ใน code และไม่ commit ขึ้น Git`}),(0,f.jsx)(p,{code:Pt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JWT Authentication`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`JWT คือ token ที่ใช้ยืนยันตัวตน — server ออก token ให้หลัง login client ส่ง token มาทุก request แทนการ login ซ้ำ`}),(0,f.jsx)(p,{code:Ft,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Refresh Token`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`JWT อย่างเดียวมีปัญหา — อายุสั้น user ต้อง login บ่อย, อายุยาว token หลุดแล้วอันตราย แก้ด้วย 2 token: Access Token อายุสั้น + Refresh Token อายุยาวไว้ขอ token ใหม่`}),(0,f.jsx)(p,{code:zt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Authentication vs Authorization`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Authentication คือ `,(0,f.jsx)(`strong`,{children:`ตรวจว่าคุณเป็นใคร`}),` (login, ตรวจ token) — Authorization คือ `,(0,f.jsx)(`strong`,{children:`ตรวจว่าคุณทำอะไรได้บ้าง`}),` (role, permission) ต้องผ่าน Authentication ก่อนเสมอ ถึงจะทำ Authorization ได้`]}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsxs)(`span`,{children:[(0,f.jsx)(`strong`,{children:`จำง่าย:`}),` Authentication = ยืนยันตัวตน (เป็นใคร) \xA0·\xA0 Authorization = ยืนยันสิทธิ์ (ทำได้ไหม)`]})]}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Middleware แยกหน้าที่ชัดเจน`}),(0,f.jsx)(p,{code:Wt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Error ที่ได้กลับมาต่างกัน`}),(0,f.jsx)(p,{code:Gt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Performance — ทำให้ Backend เร็วขึ้น`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ปัญหาหลักของ backend ช้าคือ query DB ซ้ำ, รองาน I/O ทีละอัน, และส่งข้อมูลเยอะเกินจำเป็น — แก้ได้ด้วย Connection Pool, Pagination, และ Promise.all`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Caching — อย่าดึงข้อมูลเดิมซ้ำทุก request`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`เก็บผลลัพธ์ที่ดึงมาแล้วไว้ใน Redis — request ถัดไปอ่านจาก cache แทน DB เร็วกว่าเกือบ 200 เท่า (~1ms vs ~200ms) ถ้าแก้ข้อมูลต้องล้าง cache ด้วยเสมอ`}),(0,f.jsx)(p,{code:Kt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Rate Limiting — จำกัด request ต่อ IP`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ป้องกัน server ล่มเมื่อมีคนยิง request เยอะๆ และป้องกัน brute force login ใช้ express-rate-limit ตั้งค่าได้แยกตาม route`}),(0,f.jsx)(p,{code:qt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Connection Pool — ตั้งค่าครั้งเดียว ใช้ซ้ำได้เลย`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Pool คือกลุ่ม connection ที่เปิดรอไว้ล่วงหน้า ทุก query หยิบมาใช้แล้วคืนกลับ ไม่ต้องเปิด/ปิดทุก request — Prisma มี pool built-in อยู่แล้ว ไม่ต้องตั้งค่าเพิ่ม`}),(0,f.jsx)(p,{code:Jt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Pagination — ส่งข้อมูลทีละหน้า`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ไม่ควรดึงข้อมูลทั้งหมดในครั้งเดียว ใช้ LIMIT/OFFSET (raw SQL) หรือ skip/take (Prisma) เพื่อส่งแค่ข้อมูลที่ user ต้องการในหน้านั้น`}),(0,f.jsx)(`div`,{className:`sub-section-title`,style:{fontSize:`12px`},children:`Raw SQL (pg Pool)`}),(0,f.jsx)(p,{code:Yt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,style:{fontSize:`12px`},children:`Prisma`}),(0,f.jsx)(p,{code:Xt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Promise.all — ทำงานพร้อมกัน`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ถ้า query หลายอันไม่ได้ depend กัน ให้รันพร้อมกันด้วย Promise.all เวลารวมเท่ากับอันที่นานที่สุด ไม่ใช่ผลรวมทั้งหมด`}),(0,f.jsx)(p,{code:Zt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Testing — Jest & Supertest`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ทดสอบ API endpoint โดยตรงโดยไม่ต้องรัน server จริง Jest คือ test runner, Supertest ใช้ยิง HTTP request ไปที่ Express app`}),(0,f.jsx)(p,{code:Bt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Qt})]})]})}var en=`// Basic Types — ประเภทพื้นฐาน
...
function log(msg: string): void {
  console.log(msg)
}`,tn=`// Type vs Interface — ต่างกันยังไง?
...
type Car = { color: string }  // Error: Duplicate identifier 'Car'`,nn=`// Union Type — ค่าเป็นได้หลาย type
...
}`,rn=`// Generics — เขียน code ที่ flexible แต่ยังมี type safety
...
getProperty(user, 'xxx')   // ❌ Error: ไม่มี key นี้`,an=`// Utility Types — TypeScript built-in helpers
...
// { id: number; name: string }`,on=`// Type Narrowing — บอก TS ว่าตอนนี้ type คืออะไร
...
useEffect(() => {
  ...
  fetchUser()
  return () => controller.abort()
}, [])`,cn=[{q:`TypeScript คืออะไร ทำไมต้องใช้?`,a:`TypeScript คือ JavaScript + Static Type System<br><br>
    ทำไมต้องใช้:<br>
    ...
    TS จะ narrow type ให้อัตโนมัติหลัง check`}];function ln(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`TypeScript`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`TypeScript`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน TypeScript ตั้งแต่พื้นฐานจนถึงการใช้งานจริงใน React เพื่อเตรียมสัมภาษณ์ Frontend Developer`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Basic Types`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📘`}),(0,f.jsx)(`span`,{children:`TypeScript = JavaScript + Type System — compile เป็น JS ธรรมดา browser ไม่รู้จัก TS เลย`})]}),(0,f.jsx)(p,{code:en,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Type vs Interface`}),(0,f.jsx)(p,{code:tn,lang:`typescript`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Feature`}),(0,f.jsx)(`th`,{children:`Interface`}),(0,f.jsx)(`th`,{children:`Type`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Object shape`}),(0,f.jsx)(`td`,{children:`✅`}),(0,f.jsx)(`td`,{children:`✅`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Union / Intersection`}),(0,f.jsx)(`td`,{children:`❌`}),(0,f.jsx)(`td`,{children:`✅`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`extends`}),(0,f.jsx)(`td`,{children:`✅ extends`}),(0,f.jsx)(`td`,{children:`✅ &`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Declaration Merging`}),(0,f.jsx)(`td`,{children:`✅`}),(0,f.jsx)(`td`,{children:`❌`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Primitive alias`}),(0,f.jsx)(`td`,{children:`❌`}),(0,f.jsx)(`td`,{children:`✅`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Union & Intersection Types`}),(0,f.jsx)(p,{code:nn,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Generics`}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsx)(`span`,{children:`Generics คือ "type parameter" — เหมือน function parameter แต่สำหรับ type ทำให้ reusable และ type-safe พร้อมกัน`})]}),(0,f.jsx)(p,{code:rn,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Utility Types`}),(0,f.jsx)(p,{code:an,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Type Narrowing`}),(0,f.jsx)(p,{code:on,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`TypeScript กับ React`}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚛️`}),(0,f.jsx)(`span`,{children:`React 19 + TypeScript รองรับดีมาก — type ของ Props, Hooks, และ Events ครอบคลุมทุกอย่าง`})]}),(0,f.jsx)(p,{code:sn,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:cn})]})]})}var un=`import { createContext, useContext, useState } from 'react'
...
}`,dn=`// Pattern: Custom Context Hook
...
}`,fn=`// เมื่อไหรควรใช้ Context vs Props
...
// ไม่ re-render UserContext consumers เมื่อ theme เปลี่ยน`,pn=[{q:`Context API คืออะไร และใช้แก้ปัญหาอะไร?`,a:`Context API ใช้แก้ปัญหา <strong>Prop Drilling</strong> — การส่ง props ผ่านหลาย level component ที่ไม่ได้ใช้ข้อมูลนั้นจริงๆ<br><br>
    ...
    React 19+ แนะนำ: Context สำหรับ simple, Zustand/Jotai สำหรับ complex`}],mn=(0,l.createContext)(null);function hn({children:e}){let[t,n]=(0,l.useState)(`dark`);return(0,f.jsx)(mn.Provider,{value:{theme:t,setTheme:n},children:e})}function gn(){let{theme:e,setTheme:t}=(0,l.useContext)(mn);return(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>t(e=>e===`dark`?`light`:`dark`),children:e===`dark`?`🌙 Dark Mode`:`☀️ Light Mode`})}function _n(){let{theme:e}=(0,l.useContext)(mn);return(0,f.jsxs)(`div`,{style:{padding:`16px`,borderRadius:`8px`,background:e===`dark`?`#1e2535`:`#f1f5f9`,color:e===`dark`?`#e2e8f0`:`#1e293b`,border:`1px solid ${e===`dark`?`#2d3748`:`#cbd5e1`}`,marginTop:10,fontSize:14},children:[`🃏 Card component ใช้ theme จาก Context: `,(0,f.jsx)(`strong`,{children:e})]})}function vn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useContext — Context API`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`แชร์ state ข้าม component โดยไม่ต้องส่ง props ทุก level (แก้ Prop Drilling)`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context Basics`}),(0,f.jsx)(p,{code:un})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context Pattern ที่แนะนำ`}),(0,f.jsx)(p,{code:dn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Theme Context Demo`}),(0,f.jsx)(`div`,{className:`demo-content`,children:(0,f.jsxs)(hn,{children:[(0,f.jsx)(gn,{}),(0,f.jsx)(_n,{})]})})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context vs Props — เลือกอันไหน?`}),(0,f.jsx)(p,{code:fn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:pn})]})]})}var yn=`import { useEffect, useState } from 'react'
...
}`,bn=`// Cleanup Function — ป้องกัน memory leak
...
}`,xn=`// Data Fetching Pattern ที่ถูกต้อง
...
useLayoutEffect(() => {
  ...
  setWidth(width)
}, [])`,Cn=[{q:`Dependency Array ใน useEffect คืออะไร?`,a:`Dependency Array บอก React ว่าให้ run effect เมื่อค่าใดค่าหนึ่งเปลี่ยน<br><br>
    ...
    Rule of thumb: ใช้ <code>useEffect</code> ก่อนเสมอ switch ไป <code>useLayoutEffect</code> เมื่อมีปัญหา flickering`}];function wn(){let[e,t]=(0,l.useState)(0),[n,r]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{if(!n)return;let e=setInterval(()=>t(e=>e+1),1e3);return()=>clearInterval(e)},[n]),(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,children:[(0,f.jsxs)(`span`,{className:`demo-value`,style:{fontSize:24,minWidth:80},children:[String(Math.floor(e/60)).padStart(2,`0`),`:`,String(e%60).padStart(2,`0`)]}),(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>r(e=>!e),children:n?`⏸ Pause`:`▶ Start`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>{t(0),r(!1)},children:`Reset`})]}),(0,f.jsx)(`p`,{className:`demo-label`,style:{marginTop:10},children:`useEffect cleanup ป้องกัน interval leak`})]})}function Tn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useEffect`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`จัดการ side effects: data fetching, subscriptions, timers, และ DOM manipulation`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useEffect Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🎣`}),(0,f.jsx)(`span`,{children:`useEffect ทำงานหลัง render เสมอ ใช้สำหรับ side effects ที่ไม่ใช่ rendering เช่น API calls, subscriptions`})]}),(0,f.jsx)(p,{code:yn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Cleanup Function`}),(0,f.jsx)(p,{code:bn}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Timer Demo — useEffect + Cleanup`}),(0,f.jsx)(wn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Data Fetching Pattern`}),(0,f.jsxs)(`div`,{className:`callout callout-warn`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚠️`}),(0,f.jsxs)(`span`,{children:[`ใน React 19 ควรพิจารณาใช้ `,(0,f.jsx)(`code`,{children:`use()`}),` hook หรือ library เช่น TanStack Query แทนการ fetch ใน useEffect เพื่อจัดการ loading/error states ได้ดีกว่า`]})]}),(0,f.jsx)(p,{code:xn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Effect Execution Order`}),(0,f.jsx)(p,{code:Sn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Cn})]})]})}var En=`import { useReducer } from 'react'
...
}`,Dn=`// Real-world example: Todo List with useReducer
...
}`,On=`// useReducer vs useState — เลือกอันไหน?
...
// Redux = global store ที่แชร์ระหว่าง components`,kn=[{q:`useReducer คืออะไร เมื่อไหรควรใช้แทน useState?`,a:`useReducer เป็น hook ที่ใช้ pattern <code>(state, action) => newState</code> แบบเดียวกับ Redux<br><br>
    ...
    React ใช้ strict mode run reducer 2 ครั้งเพื่อ detect side effects`}],An={todos:[],filter:`all`};function jn(e,t){switch(t.type){case`ADD`:return t.payload.trim()?{...e,todos:[...e.todos,{id:Date.now(),text:t.payload,done:!1}]}:e;case`TOGGLE`:return{...e,todos:e.todos.map(e=>e.id===t.payload?{...e,done:!e.done}:e)};case`DELETE`:return{...e,todos:e.todos.filter(e=>e.id!==t.payload)};case`FILTER`:return{...e,filter:t.payload};default:return e}}function Mn(){let[e,t]=(0,l.useReducer)(jn,An),[n,r]=(0,l.useState)(``),i=e.todos.filter(t=>e.filter===`active`?!t.done:e.filter===`done`?t.done:!0);return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`input`,{className:`demo-input`,value:n,onChange:e=>r(e.target.value),onKeyDown:e=>{e.key===`Enter`&&(t({type:`ADD`,payload:n}),r(``))},placeholder:`Add todo... (Enter)`,style:{flex:1}}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>{t({type:`ADD`,payload:n}),r(``)},children:`Add`})]}),(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[[`all`,`active`,`done`].map(n=>(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{background:e.filter===n?`rgba(97,218,251,0.2)`:void 0,borderColor:e.filter===n?`#61dafb`:void 0},onClick:()=>t({type:`FILTER`,payload:n}),children:n},n)),(0,f.jsxs)(`span`,{className:`demo-label`,children:[e.todos.filter(e=>!e.done).length,` remaining`]})]}),(0,f.jsxs)(`ul`,{className:`demo-list`,children:[i.length===0&&(0,f.jsx)(`li`,{className:`demo-list-item`,style:{color:`#4b5563`,justifyContent:`center`},children:`No todos`}),i.map(e=>(0,f.jsxs)(`li`,{className:`demo-list-item`,children:[(0,f.jsxs)(`span`,{style:{textDecoration:e.done?`line-through`:`none`,color:e.done?`#4b5563`:`#e2e8f0`,cursor:`pointer`,flex:1},onClick:()=>t({type:`TOGGLE`,payload:e.id}),children:[e.done?`✅`:`⬜`,` `,e.text]}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{background:`rgba(248,113,113,0.1)`,borderColor:`rgba(248,113,113,0.3)`,color:`#f87171`},onClick:()=>t({type:`DELETE`,payload:e.id}),children:`Delete`})]},e.id))]})]})}function Nn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useReducer`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`จัดการ complex state ด้วย Reducer pattern — เหมือน Redux แต่อยู่ใน component`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useReducer Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🔄`}),(0,f.jsxs)(`span`,{children:[`Pattern: `,(0,f.jsx)(`code`,{children:`dispatch(action)`}),` → `,(0,f.jsx)(`code`,{children:`reducer(currentState, action)`}),` → `,(0,f.jsx)(`code`,{children:`newState`})]})]}),(0,f.jsx)(p,{code:En})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Todo App — Real World Example`}),(0,f.jsx)(p,{code:Dn}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Todo Demo — useReducer`}),(0,f.jsx)(Mn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useReducer vs useState`}),(0,f.jsx)(p,{code:On})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:kn})]})]})}var Pn=`import { useRef } from 'react'
...
}`,In=`import { forwardRef, useImperativeHandle } from 'react'
...
const VideoPlayer = forwardRef((props, ref) => {
  ...
  return <video ref={videoRef} {...props} />
})`,Ln=[{q:`useRef กับ useState ต่างกันอย่างไร?`,a:`<strong>useState:</strong> เมื่อ setter ถูกเรียก React จะ re-render component<br>
    ...
    <code>ref</code> กลายเป็น regular prop ได้เลย`}];function Rn(){let e=(0,l.useRef)(null),t=(0,l.useRef)(0),[n,r]=(0,l.useState)(``);return t.current++,(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`input`,{ref:e,className:`demo-input`,value:n,onChange:e=>r(e.target.value),placeholder:`Type something...`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>e.current.focus(),children:`Focus`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>r(``),children:`Clear`})]}),(0,f.jsxs)(`div`,{className:`demo-label`,children:[`Render count (via ref, no re-render): `,(0,f.jsx)(`strong`,{style:{color:`#61dafb`},children:t.current})]})]})}function zn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useRef`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`เก็บค่า mutable และ DOM references โดยไม่ trigger re-render`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useRef Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📎`}),(0,f.jsxs)(`span`,{children:[(0,f.jsx)(`code`,{children:`useRef`}),` คือ "กล่อง" ที่เก็บค่า — เปลี่ยนค่าใน `,(0,f.jsx)(`code`,{children:`.current`}),` ได้ตลอดเวลาโดยไม่ทำให้ re-render`]})]}),(0,f.jsx)(p,{code:Pn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useRef vs useState`}),(0,f.jsx)(p,{code:Fn}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Feature`}),(0,f.jsx)(`th`,{children:`useState`}),(0,f.jsx)(`th`,{children:`useRef`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Triggers re-render`}),(0,f.jsx)(`td`,{children:`✅ Yes`}),(0,f.jsx)(`td`,{children:`❌ No`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Mutable`}),(0,f.jsx)(`td`,{children:`No (use setter)`}),(0,f.jsx)(`td`,{children:`✅ Yes (.current)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`DOM access`}),(0,f.jsx)(`td`,{children:`❌ No`}),(0,f.jsx)(`td`,{children:`✅ Yes`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Persists across renders`}),(0,f.jsx)(`td`,{children:`✅ Yes`}),(0,f.jsx)(`td`,{children:`✅ Yes`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`DOM Ref + Render Counter`}),(0,f.jsx)(Rn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`forwardRef & useImperativeHandle`}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🆕`}),(0,f.jsxs)(`span`,{children:[`React 19: `,(0,f.jsx)(`code`,{children:`forwardRef`}),` ไม่จำเป็นแล้ว! สามารถส่ง `,(0,f.jsx)(`code`,{children:`ref`}),` เป็น regular prop ได้เลย`]})]}),(0,f.jsx)(p,{code:In})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Ln})]})]})}var Bn=`<!-- Single File Component (.vue) — โครงสร้างพื้นฐาน -->
...
h1 { color: #42b883; }
</style>`,Vn=`// ref — ใช้กับค่าเดี่ยว (primitive)
...
form.username = 'alice'
form.remember = true`,Hn=`<!-- Template Syntax — วิธีเขียน HTML ใน Vue -->
...
</template>`,Un=`// Computed — คำนวณค่าจาก reactive data (เหมือน useMemo ใน React)
...
})`,Wn=`// Lifecycle Hooks — เหมือน useEffect แต่แยกชัดเจน
import {
  onMounted,
  onUpdated,
  onUnmounted,
...
// onMounted    ≈ useEffect(() => {}, [])
// onUpdated    ≈ useEffect(() => {})
// onUnmounted  ≈ return () => {} ใน useEffect`,Gn=`<!-- Parent Component -->
<template>
  <UserCard
    :name="userName"
    :age="userAge"
...
<\/script>`,Kn=`// Composable — เหมือน Custom Hook ใน React
...
// const { data, loading, error } = useFetch('/api/users')`,qn=`// Pinia — Global State (เหมือน Zustand ใน React)
...
console.log(userStore.displayName)`,Jn=`// Vue Router — จัดการ URL (เหมือน React Router)
...
<\/script>`,Yn=[{q:`Vue 3 กับ React ต่างกันอย่างไร?`,a:`<strong>ความเหมือน:</strong> Component-based, Virtual DOM, Reactivity, Lifecycle<br><br>
    ...
    ถ้าข้อมูลใช้แค่ใน component เดียวหรือ parent-child → ใช้ props/emit ธรรมดาพอ`}];function Xn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Frontend`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`Vue 3`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`เรียนรู้ Vue 3 Composition API สำหรับ React developer แนวคิดเหมือนกัน แค่ syntax และวิธีคิดต่างออกไป`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Single File Component (SFC)`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue ใช้ไฟล์ `,(0,f.jsx)(`code`,{children:`.vue`}),` ที่รวม HTML, JS, CSS ไว้ในไฟล์เดียว แบ่งเป็น 3 ส่วนชัดเจน — ต่างจาก React ที่รวม HTML ไว้ใน JS ผ่าน JSX`]}),(0,f.jsx)(p,{code:Bn,lang:`html`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`ref & reactive — Reactivity System`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue track การเปลี่ยนแปลงด้วย Proxy — ต้องห่อค่าด้วย `,(0,f.jsx)(`code`,{children:`ref`}),` หรือ `,(0,f.jsx)(`code`,{children:`reactive`}),`ก่อน Vue จึงจะรู้ว่าค่าเปลี่ยนและ re-render ให้อัตโนมัติ`]}),(0,f.jsx)(p,{code:Vn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Template Syntax`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue ใช้ directive (`,(0,f.jsx)(`code`,{children:`v-if`}),`, `,(0,f.jsx)(`code`,{children:`v-for`}),`, `,(0,f.jsx)(`code`,{children:`v-model`}),`) แทน JSX expression —`,(0,f.jsx)(`code`,{children:`v-model`}),` พิเศษตรงที่ bind ค่าเข้า-ออกในบรรทัดเดียว ไม่ต้องเขียน onChange เอง`]}),(0,f.jsx)(p,{code:Hn,lang:`html`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Computed & Watch`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`computed`}),` คำนวณค่าจาก reactive data แล้ว cache ไว้ (เหมือน useMemo) —`,(0,f.jsx)(`code`,{children:`watch`}),` ดูการเปลี่ยนแปลงแล้วทำ side effect (เหมือน useEffect)`]}),(0,f.jsx)(p,{code:Un,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Lifecycle Hooks`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue มี lifecycle hook แยกชัดเจนแต่ละจังหวะ ต่างจาก React ที่ใช้ `,(0,f.jsx)(`code`,{children:`useEffect`}),`ทำทุกอย่างโดยควบคุมผ่าน dependency array`]}),(0,f.jsx)(p,{code:Wn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Props & Emit`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Props ส่งข้อมูลจาก parent → child, Emit ส่ง event จาก child → parent — แทนที่จะส่ง callback function เป็น prop แบบ React, Vue ใช้ event system แยก`}),(0,f.jsx)(p,{code:Gn,lang:`html`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Composables`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Composable คือ function ที่แยก logic ที่ใช้ซ้ำออกมา — เหมือน Custom Hook ใน React ตั้งชื่อขึ้นต้นด้วย `,(0,f.jsx)(`code`,{children:`use`}),` เสมอ`]}),(0,f.jsx)(p,{code:Kn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Pinia — Global State`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Pinia คือ state management ของ Vue 3 ทำงานคล้าย Zustand — ใช้เมื่อข้อมูลต้องแชร์ระหว่าง component ที่ไม่ได้เป็น parent-child กัน`}),(0,f.jsx)(p,{code:qn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Vue Router`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Vue Router จัดการ URL และ navigation — คล้าย React Router มี Navigation Guard ไว้ตรวจสอบสิทธิ์ก่อนเข้า route`}),(0,f.jsx)(p,{code:Jn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Yn})]})]})}var Zn=[{id:`home`,label:`หน้าหลัก`,icon:`🏠`},{section:`พื้นฐาน`},{id:`jsx`,label:`JSX & Components`,icon:`⚛️`},{id:`props`,label:`Props & State`,icon:`📦`},{section:`Hooks`},{id:`useeffect`,label:`useEffect`,icon:`🎣`},{id:`usecontext`,label:`useContext`,icon:`🔗`},{id:`useref`,label:`useRef`,icon:`📎`},{id:`memo`,label:`useMemo & useCallback`,icon:`⚡`},{id:`usereducer`,label:`useReducer`,icon:`🔄`},{section:`Advanced`},{id:`customhooks`,label:`Custom Hooks`,icon:`🪝`},{id:`react19`,label:`React 19 Features`,icon:`🚀`},{section:`JavaScript`},{id:`array`,label:`Array Methods`,icon:`📋`},{section:`Backend`},{id:`nodejs`,label:`Node.js`,icon:`🟩`},{section:`Database`},{id:`sql`,label:`SQL`,icon:`🗄️`},{section:`TypeScript`},{id:`typescript`,label:`TypeScript`,icon:`📘`},{section:`DevOps`},{id:`builddeploy`,label:`Build → Deploy → Browser`,icon:`🚢`},{id:`docker`,label:`Docker`,icon:`🐳`},{section:`Vue.js`},{id:`vue`,label:`Vue 3`,icon:`💚`},{section:`สัมภาษณ์`},{id:`interview`,label:`Interview Q&A`,icon:`❓`}],Qn={home:De,jsx:Ie,props:Qe,useeffect:Tn,usecontext:vn,useref:zn,memo:We,usereducer:Nn,customhooks:fe,react19:ot,array:x,nodejs:$t,sql:wt,builddeploy:oe,typescript:ln,docker:Te,vue:Xn,interview:ke};function $n(){let[e,t]=(0,l.useState)(`home`),n=e=>{t(e),window.scrollTo(0,0)},r=Qn[e]||De;return(0,f.jsxs)(`div`,{className:`app`,children:[(0,f.jsxs)(`aside`,{className:`sidebar`,children:[(0,f.jsxs)(`div`,{className:`sidebar-header`,children:[(0,f.jsxs)(`div`,{className:`sidebar-title`,children:[(0,f.jsx)(`span`,{children:`⚛️`}),` React Interview`]}),(0,f.jsx)(`div`,{className:`sidebar-subtitle`,children:`Welcome to Basic Web Developer Prep · React`})]}),(0,f.jsx)(`nav`,{className:`sidebar-nav`,children:Zn.map((t,r)=>t.section?(0,f.jsx)(`div`,{className:`nav-section-label`,children:t.section},r):(0,f.jsxs)(`div`,{className:`nav-item ${e===t.id?`active`:``}`,onClick:()=>n(t.id),children:[(0,f.jsx)(`span`,{className:`nav-icon`,children:t.icon}),(0,f.jsx)(`span`,{children:t.label})]},t.id))})]}),(0,f.jsx)(`main`,{className:`main-content`,children:(0,f.jsx)(r,{onNavigate:n})})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)($n,{})}));