...
SELECT * FROM users WHERE dept_id IS NULL;`,lt=`-- ORDER BY เรียงผลลัพธ์
...
SELECT * FROM users
ORDER BY id
LIMIT 10 OFFSET 20;  -- แถวที่ 21-30`,ut=`--  ตาราง users          ตาราง departments
--  +---------+-------+   +----+-----------+
...
-- ผล: Alice-Engineer, Bob-Marketing, NULL-HR`,dt=`-- Aggregate Functions — คำนวณจากหลายแถว
...
SELECT MAX(amount) FROM orders;  -- มากสุด`,ft=`-- GROUP BY จัดกลุ่มแถวที่ค่าเท่ากันไว้ด้วยกัน
...
-- ⚠️ ลำดับการทำงาน SQL
-- FROM → WHERE → GROUP BY → HAVING → SELECT → ORDER BY → LIMIT`,pt=`-- Subquery คือ query ที่ซ้อนอยู่ใน query อื่น
...
);`,mt=`-- CTE (Common Table Expression) คือการตั้งชื่อ query ชั่วคราว
...
FROM users u
JOIN high_spenders hs ON u.id = hs.user_id;`,ht=`-- Window Function คำนวณโดยไม่ยุบแถว
...
FROM orders;`,gt=`-- Index คือโครงสร้างข้อมูลพิเศษที่ทำให้ค้นหาเร็วขึ้น
...
EXPLAIN SELECT * FROM users WHERE email = 'alice@test.com';`,O=`-- Transaction คือการรวมหลาย query ให้เป็นหน่วยเดียว
...
ROLLBACK;  -- ยกเลิกทุกอย่าง → เงิน A ไม่หายไป`,_t=[{q:`WHERE กับ HAVING ต่างกันอย่างไร?`,a:`ทั้งคู่ใช้กรองข้อมูล แต่ทำงานคนละช่วง<br><br>
    ...
    แนะนำ: ใช้ CTE แทน subquery ซ้อนเกิน 1 ชั้น ทีมอ่านง่ายกว่ามาก`}];function vt(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Database`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`SQL`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน SQL ตั้งแต่พื้นฐานจนถึงขั้นสูง พร้อม pattern ที่เจอในการสัมภาษณ์งาน`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Schema ตัวอย่าง`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`ใช้ 3 ตารางนี้เป็น reference ตลอดหน้า — `,(0,f.jsx)(`code`,{children:`users`}),` เชื่อมกับ `,(0,f.jsx)(`code`,{children:`departments`}),` ผ่าน `,(0,f.jsx)(`code`,{children:`dept_id`}),` และเชื่อมกับ `,(0,f.jsx)(`code`,{children:`orders`}),` ผ่าน `,(0,f.jsx)(`code`,{children:`user_id`})]}),(0,f.jsx)(p,{code:st,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`SELECT / WHERE`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`SELECT`}),` เลือกคอลัมน์, `,(0,f.jsx)(`code`,{children:`WHERE`}),` กรองแถวตามเงื่อนไข — ใช้ `,(0,f.jsx)(`code`,{children:`LIKE`}),` สำหรับ pattern matching และ `,(0,f.jsx)(`code`,{children:`IS NULL`}),` ตรวจค่าว่าง (ใช้ `,(0,f.jsx)(`code`,{children:`= NULL`}),` ไม่ได้)`]}),(0,f.jsx)(p,{code:ct,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`ORDER BY / LIMIT / DISTINCT`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`ORDER BY`}),` เรียงผลลัพธ์, `,(0,f.jsx)(`code`,{children:`LIMIT`}),` + `,(0,f.jsx)(`code`,{children:`OFFSET`}),` ใช้ทำ pagination — หน้าที่ n ใช้ `,(0,f.jsx)(`code`,{children:`OFFSET (n-1) * pageSize`})]}),(0,f.jsx)(p,{code:lt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JOIN`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`JOIN ใช้ดึงข้อมูลจากหลายตารางมารวมกัน โดยระบุเงื่อนไขการเชื่อม (`,(0,f.jsx)(`code`,{children:`ON`}),`) — ประเภทของ JOIN กำหนดว่าจะเอาแถวไหนบ้างเมื่อไม่มี match`]}),(0,f.jsx)(p,{code:ut,lang:`sql`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`JOIN`}),(0,f.jsx)(`th`,{children:`คืนอะไร`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`INNER JOIN`}),(0,f.jsx)(`td`,{children:`เฉพาะแถวที่ match ทั้งสองฝั่ง`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`LEFT JOIN`}),(0,f.jsx)(`td`,{children:`ทุกแถวจากซ้าย + match จากขวา (NULL ถ้าไม่มี)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`RIGHT JOIN`}),(0,f.jsx)(`td`,{children:`ทุกแถวจากขวา + match จากซ้าย (NULL ถ้าไม่มี)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`FULL OUTER JOIN`}),(0,f.jsx)(`td`,{children:`ทุกแถวทั้งสองฝั่ง (NULL ถ้าไม่มี match)`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Aggregate Functions`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Aggregate function คำนวณค่าจากหลายแถวให้เป็นค่าเดียว เช่น รวม นับ หาค่าเฉลี่ย — มักใช้คู่กับ `,(0,f.jsx)(`code`,{children:`GROUP BY`})]}),(0,f.jsx)(p,{code:dt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`GROUP BY / HAVING`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`GROUP BY`}),` จัดกลุ่มแถวที่ค่าคอลัมน์เหมือนกันไว้ด้วยกัน แล้ว aggregate แต่ละกลุ่ม — `,(0,f.jsx)(`code`,{children:`HAVING`}),` ใช้กรองกลุ่มหลัง GROUP BY (ต่างจาก WHERE ที่กรองก่อน)`]}),(0,f.jsx)(p,{code:ft,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Subquery`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Subquery คือ query ซ้อนใน query — ผลของ subquery ถูกใช้เป็น input ให้ outer query ใช้ใน WHERE, FROM, หรือ SELECT ก็ได้`}),(0,f.jsx)(p,{code:pt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`CTE — WITH clause`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`CTE คือการตั้งชื่อให้ query ชั่วคราว ทำให้อ่านง่ายกว่า subquery ซ้อนหลายชั้น — ผลของ CTE จะถูก reuse ได้ใน query เดียวกัน`}),(0,f.jsx)(p,{code:mt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Window Functions`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Window Function คำนวณค่าโดยพิจารณา "หน้าต่าง" ของแถวรอบข้าง (`,(0,f.jsx)(`code`,{children:`OVER`}),`) — ต่างจาก GROUP BY ตรงที่ไม่ยุบแถว ทุกแถวยังอยู่ครบ`]}),(0,f.jsx)(p,{code:ht,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Index`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Index คือโครงสร้างข้อมูลพิเศษที่สร้างขึ้นมาเพิ่มเติม ช่วยให้ DB กระโดดไปหาแถวที่ต้องการได้โดยตรง ไม่ต้องอ่านทุกแถว — แต่ทำให้ write ช้าลงเล็กน้อยเพราะต้อง update index ด้วย`}),(0,f.jsx)(p,{code:gt,lang:`sql`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Transaction & ACID`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Transaction รวม query หลายตัวให้เป็นหน่วยเดียว — ถ้า query ใดล้มเหลว ทุกอย่างถูกยกเลิก (ROLLBACK) ป้องกันข้อมูลค้างกลางๆ ระหว่างการทำงาน`}),(0,f.jsx)(p,{code:O,lang:`sql`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`ACID`}),(0,f.jsx)(`th`,{children:`หมายถึง`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Atomicity`}),(0,f.jsx)(`td`,{children:`ทำครบหรือไม่ทำเลย ไม่มีครึ่งๆ กลางๆ`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Consistency`}),(0,f.jsx)(`td`,{children:`ข้อมูลถูกต้องตาม constraint ก่อนและหลัง transaction`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Isolation`}),(0,f.jsx)(`td`,{children:`หลาย transaction รันพร้อมกันต้องไม่กระทบกัน`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Durability`}),(0,f.jsx)(`td`,{children:`COMMIT แล้วข้อมูลถาวร แม้ระบบล่ม`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:_t})]})]})}var yt=`// Node.js คือ JavaScript runtime บน server
...
server.listen(3000)
// เปิด browser ไปที่ localhost:3000 → เห็น Hello World`,bt=`// ❌ Blocking — PHP / Python แบบดั้งเดิม
...
console.log(data)
// ระหว่าง 500ms นั้น request อื่นเข้ามาก็ต้องค้างรอหมด`,xt=`// ✅ Non-blocking — Node.js
...
// 3. อ่านไฟล์เสร็จแล้ว  ← มาทีหลัง`,St=`// async/await — เขียนง่ายกว่า callback แต่ยัง non-blocking
...
// ไม่ได้ยืนรอครัวทำอาหารโต๊ะ 1 เสร็จก่อน`,wt=`// Express — framework ยอดนิยมสำหรับทำ API
...
app.listen(3000, () => console.log('Server running on port 3000'))`,Tt=`// REST API — มาตรฐานการออกแบบ API
...
500 Server Error → server พัง`,Et=`// Middleware — function ที่ทำงานระหว่าง request → response
...
})`,Dt=`// Router — แยก route ออกเป็นไฟล์ย่อย
...
app.use('/orders', orderRouter)  // /orders, /orders/:id`,Ot=`// Error Handling
...
})`,k=`// Environment Variables — ค่าที่ต่างกันในแต่ละ env
...
// ✅ deploy บน server ต่างๆ ใช้ค่าต่างกันได้`,kt=`// JWT Authentication — ระบบ login ที่นิยมที่สุด
...
app.get('/me', authenticate, (req, res) => {
  res.json(req.user)
})`,At=`// Authentication — ตรวจว่าคุณเป็นใคร
...
// → 403 Forbidden`,Mt=[{q:`Node.js คืออะไร ต่างจาก Browser JavaScript ยังไง?`,a:`Node.js คือ JavaScript runtime บน server — ทำให้ JS รันนอก browser ได้<br><br>
    ...
    ในทางปฏิบัติส่วนใหญ่ใช้ PATCH เพราะ flexible กว่า`}];function Nt(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Backend`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`Node.js Backend`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน Node.js และ Express สำหรับทำ REST API พร้อม pattern ที่ใช้จริงในงาน`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Node.js คืออะไร`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Node.js คือ JavaScript runtime ที่ทำให้ JS รันบน server ได้ ก่อนหน้านี้ JS รันได้แค่ใน browser เท่านั้น`}),(0,f.jsx)(p,{code:yt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Event Loop — Non-blocking I/O`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Node.js รัน thread เดียว แต่รับ request พร้อมกันได้เยอะ เพราะงาน I/O (อ่านไฟล์, query DB, เรียก API) จะถูกส่งให้ OS ทำแทน Node.js ไม่รอ — วิ่งรับ request ถัดไปได้เลย`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`ปัญหาของ Blocking`}),(0,f.jsx)(p,{code:bt,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Non-blocking แก้ยังไง`}),(0,f.jsx)(p,{code:xt,lang:`javascript`}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsxs)(`span`,{children:[`สังเกตว่า output ไม่ได้เรียงตามลำดับที่เขียน — เพราะ Node.js ไม่รอ `,(0,f.jsx)(`code`,{children:`readFile`}),` แต่วิ่งต่อไปก่อน แล้วค่อยกลับมารัน callback ทีหลังเมื่อเสร็จ`]})]}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`async/await — เขียนง่ายขึ้น`}),(0,f.jsx)(p,{code:St,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Event Loop ภาพรวม`}),(0,f.jsx)(p,{code:Ct,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Express — ทำ API`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Express คือ framework ยอดนิยมของ Node.js สำหรับทำ web server และ API ให้โครงสร้าง routing และ middleware ที่ใช้งานง่าย`}),(0,f.jsx)(p,{code:wt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`REST API Design`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`REST คือมาตรฐานการออกแบบ API โดยใช้ HTTP Method บอกว่าจะทำอะไร และ URL บอกว่าทำกับอะไร — ทำให้ API อ่านง่ายและคาดเดาได้`}),(0,f.jsx)(p,{code:Tt,lang:`bash`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Middleware`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Middleware คือ function ที่ทำงานระหว่าง request เข้ามาและ response ออกไป ทุก request ผ่าน middleware ตามลำดับก่อนถึง route handler`}),(0,f.jsx)(p,{code:Et,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Router — แยกไฟล์`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`เมื่อโปรเจกต์ใหญ่ขึ้น ควรแยก route ออกเป็นไฟล์ย่อยตาม resource ทำให้ code อ่านง่ายและจัดการได้ง่ายขึ้น`}),(0,f.jsx)(p,{code:Dt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Error Handling`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ทุก async route ต้องมี try/catch และส่ง error ไปให้ error handler middleware Express มี error handler พิเศษที่รับ 4 parameter (err, req, res, next)`}),(0,f.jsx)(p,{code:Ot,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Environment Variables`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`ค่าที่ต่างกันในแต่ละ environment เช่น DB URL, API key, password ต้องเก็บใน .env ไม่ใส่ตรงๆ ใน code และไม่ commit ขึ้น Git`}),(0,f.jsx)(p,{code:k,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`JWT Authentication`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`JWT คือ token ที่ใช้ยืนยันตัวตน — server ออก token ให้หลัง login client ส่ง token มาทุก request แทนการ login ซ้ำ`}),(0,f.jsx)(p,{code:kt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Authentication vs Authorization`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Authentication คือ `,(0,f.jsx)(`strong`,{children:`ตรวจว่าคุณเป็นใคร`}),` (login, ตรวจ token) — Authorization คือ `,(0,f.jsx)(`strong`,{children:`ตรวจว่าคุณทำอะไรได้บ้าง`}),` (role, permission) ต้องผ่าน Authentication ก่อนเสมอ ถึงจะทำ Authorization ได้`]}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsxs)(`span`,{children:[(0,f.jsx)(`strong`,{children:`จำง่าย:`}),` Authentication = ยืนยันตัวตน (เป็นใคร) \xA0·\xA0 Authorization = ยืนยันสิทธิ์ (ทำได้ไหม)`]})]}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Middleware แยกหน้าที่ชัดเจน`}),(0,f.jsx)(p,{code:At,lang:`javascript`}),(0,f.jsx)(`div`,{className:`sub-section-title`,children:`Error ที่ได้กลับมาต่างกัน`}),(0,f.jsx)(p,{code:jt,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Mt})]})]})}var Pt=`// Basic Types — ประเภทพื้นฐาน
...
function log(msg: string): void {
  console.log(msg)
}`,Ft=`// Type vs Interface — ต่างกันยังไง?
...
type Car = { color: string }  // Error: Duplicate identifier 'Car'`,It=`// Union Type — ค่าเป็นได้หลาย type
...
}`,Lt=`// Generics — เขียน code ที่ flexible แต่ยังมี type safety
...
getProperty(user, 'xxx')   // ❌ Error: ไม่มี key นี้`,Rt=`// Utility Types — TypeScript built-in helpers
...
// { id: number; name: string }`,zt=`// Type Narrowing — บอก TS ว่าตอนนี้ type คืออะไร
...
useEffect(() => {
  ...
  fetchUser()
  return () => controller.abort()
}, [])`,Vt=[{q:`TypeScript คืออะไร ทำไมต้องใช้?`,a:`TypeScript คือ JavaScript + Static Type System<br><br>
    ทำไมต้องใช้:<br>
    ...
    TS จะ narrow type ให้อัตโนมัติหลัง check`}];function Ht(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`TypeScript`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`TypeScript`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`ทบทวน TypeScript ตั้งแต่พื้นฐานจนถึงการใช้งานจริงใน React เพื่อเตรียมสัมภาษณ์ Frontend Developer`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Basic Types`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📘`}),(0,f.jsx)(`span`,{children:`TypeScript = JavaScript + Type System — compile เป็น JS ธรรมดา browser ไม่รู้จัก TS เลย`})]}),(0,f.jsx)(p,{code:Pt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Type vs Interface`}),(0,f.jsx)(p,{code:Ft,lang:`typescript`}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Feature`}),(0,f.jsx)(`th`,{children:`Interface`}),(0,f.jsx)(`th`,{children:`Type`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Object shape`}),(0,f.jsx)(`td`,{children:`✅`}),(0,f.jsx)(`td`,{children:`✅`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Union / Intersection`}),(0,f.jsx)(`td`,{children:`❌`}),(0,f.jsx)(`td`,{children:`✅`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`extends`}),(0,f.jsx)(`td`,{children:`✅ extends`}),(0,f.jsx)(`td`,{children:`✅ &`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Declaration Merging`}),(0,f.jsx)(`td`,{children:`✅`}),(0,f.jsx)(`td`,{children:`❌`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Primitive alias`}),(0,f.jsx)(`td`,{children:`❌`}),(0,f.jsx)(`td`,{children:`✅`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Union & Intersection Types`}),(0,f.jsx)(p,{code:It,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Generics`}),(0,f.jsxs)(`div`,{className:`callout callout-tip`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`💡`}),(0,f.jsx)(`span`,{children:`Generics คือ "type parameter" — เหมือน function parameter แต่สำหรับ type ทำให้ reusable และ type-safe พร้อมกัน`})]}),(0,f.jsx)(p,{code:Lt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Utility Types`}),(0,f.jsx)(p,{code:Rt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Type Narrowing`}),(0,f.jsx)(p,{code:zt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`TypeScript กับ React`}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚛️`}),(0,f.jsx)(`span`,{children:`React 19 + TypeScript รองรับดีมาก — type ของ Props, Hooks, และ Events ครอบคลุมทุกอย่าง`})]}),(0,f.jsx)(p,{code:Bt,lang:`typescript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Vt})]})]})}var Ut=`import { createContext, useContext, useState } from 'react'
...
}`,Wt=`// Pattern: Custom Context Hook
...
}`,Gt=`// เมื่อไหรควรใช้ Context vs Props
...
// ไม่ re-render UserContext consumers เมื่อ theme เปลี่ยน`,Kt=[{q:`Context API คืออะไร และใช้แก้ปัญหาอะไร?`,a:`Context API ใช้แก้ปัญหา <strong>Prop Drilling</strong> — การส่ง props ผ่านหลาย level component ที่ไม่ได้ใช้ข้อมูลนั้นจริงๆ<br><br>
    ...
    React 19+ แนะนำ: Context สำหรับ simple, Zustand/Jotai สำหรับ complex`}],qt=(0,l.createContext)(null);function Jt({children:e}){let[t,n]=(0,l.useState)(`dark`);return(0,f.jsx)(qt.Provider,{value:{theme:t,setTheme:n},children:e})}function Yt(){let{theme:e,setTheme:t}=(0,l.useContext)(qt);return(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>t(e=>e===`dark`?`light`:`dark`),children:e===`dark`?`🌙 Dark Mode`:`☀️ Light Mode`})}function Xt(){let{theme:e}=(0,l.useContext)(qt);return(0,f.jsxs)(`div`,{style:{padding:`16px`,borderRadius:`8px`,background:e===`dark`?`#1e2535`:`#f1f5f9`,color:e===`dark`?`#e2e8f0`:`#1e293b`,border:`1px solid ${e===`dark`?`#2d3748`:`#cbd5e1`}`,marginTop:10,fontSize:14},children:[`🃏 Card component ใช้ theme จาก Context: `,(0,f.jsx)(`strong`,{children:e})]})}function Zt(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useContext — Context API`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`แชร์ state ข้าม component โดยไม่ต้องส่ง props ทุก level (แก้ Prop Drilling)`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context Basics`}),(0,f.jsx)(p,{code:Ut})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context Pattern ที่แนะนำ`}),(0,f.jsx)(p,{code:Wt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Theme Context Demo`}),(0,f.jsx)(`div`,{className:`demo-content`,children:(0,f.jsxs)(Jt,{children:[(0,f.jsx)(Yt,{}),(0,f.jsx)(Xt,{})]})})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Context vs Props — เลือกอันไหน?`}),(0,f.jsx)(p,{code:Gt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:Kt})]})]})}var Qt=`import { useEffect, useState } from 'react'
...
}`,$t=`// Cleanup Function — ป้องกัน memory leak
...
}`,en=`// Data Fetching Pattern ที่ถูกต้อง
...
useLayoutEffect(() => {
  ...
  setWidth(width)
}, [])`,nn=[{q:`Dependency Array ใน useEffect คืออะไร?`,a:`Dependency Array บอก React ว่าให้ run effect เมื่อค่าใดค่าหนึ่งเปลี่ยน<br><br>
    ...
    Rule of thumb: ใช้ <code>useEffect</code> ก่อนเสมอ switch ไป <code>useLayoutEffect</code> เมื่อมีปัญหา flickering`}];function rn(){let[e,t]=(0,l.useState)(0),[n,r]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{if(!n)return;let e=setInterval(()=>t(e=>e+1),1e3);return()=>clearInterval(e)},[n]),(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,children:[(0,f.jsxs)(`span`,{className:`demo-value`,style:{fontSize:24,minWidth:80},children:[String(Math.floor(e/60)).padStart(2,`0`),`:`,String(e%60).padStart(2,`0`)]}),(0,f.jsx)(`button`,{className:`demo-btn`,onClick:()=>r(e=>!e),children:n?`⏸ Pause`:`▶ Start`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>{t(0),r(!1)},children:`Reset`})]}),(0,f.jsx)(`p`,{className:`demo-label`,style:{marginTop:10},children:`useEffect cleanup ป้องกัน interval leak`})]})}function an(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useEffect`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`จัดการ side effects: data fetching, subscriptions, timers, และ DOM manipulation`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useEffect Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🎣`}),(0,f.jsx)(`span`,{children:`useEffect ทำงานหลัง render เสมอ ใช้สำหรับ side effects ที่ไม่ใช่ rendering เช่น API calls, subscriptions`})]}),(0,f.jsx)(p,{code:Qt})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Cleanup Function`}),(0,f.jsx)(p,{code:$t}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Timer Demo — useEffect + Cleanup`}),(0,f.jsx)(rn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Data Fetching Pattern`}),(0,f.jsxs)(`div`,{className:`callout callout-warn`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`⚠️`}),(0,f.jsxs)(`span`,{children:[`ใน React 19 ควรพิจารณาใช้ `,(0,f.jsx)(`code`,{children:`use()`}),` hook หรือ library เช่น TanStack Query แทนการ fetch ใน useEffect เพื่อจัดการ loading/error states ได้ดีกว่า`]})]}),(0,f.jsx)(p,{code:en})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Effect Execution Order`}),(0,f.jsx)(p,{code:tn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:nn})]})]})}var on=`import { useReducer } from 'react'
...
}`,sn=`// Real-world example: Todo List with useReducer
...
}`,cn=`// useReducer vs useState — เลือกอันไหน?
...
// Redux = global store ที่แชร์ระหว่าง components`,ln=[{q:`useReducer คืออะไร เมื่อไหรควรใช้แทน useState?`,a:`useReducer เป็น hook ที่ใช้ pattern <code>(state, action) => newState</code> แบบเดียวกับ Redux<br><br>
    ...
    React ใช้ strict mode run reducer 2 ครั้งเพื่อ detect side effects`}],un={todos:[],filter:`all`};function dn(e,t){switch(t.type){case`ADD`:return t.payload.trim()?{...e,todos:[...e.todos,{id:Date.now(),text:t.payload,done:!1}]}:e;case`TOGGLE`:return{...e,todos:e.todos.map(e=>e.id===t.payload?{...e,done:!e.done}:e)};case`DELETE`:return{...e,todos:e.todos.filter(e=>e.id!==t.payload)};case`FILTER`:return{...e,filter:t.payload};default:return e}}function fn(){let[e,t]=(0,l.useReducer)(dn,un),[n,r]=(0,l.useState)(``),i=e.todos.filter(t=>e.filter===`active`?!t.done:e.filter===`done`?t.done:!0);return(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`input`,{className:`demo-input`,value:n,onChange:e=>r(e.target.value),onKeyDown:e=>{e.key===`Enter`&&(t({type:`ADD`,payload:n}),r(``))},placeholder:`Add todo... (Enter)`,style:{flex:1}}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>{t({type:`ADD`,payload:n}),r(``)},children:`Add`})]}),(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[[`all`,`active`,`done`].map(n=>(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{background:e.filter===n?`rgba(97,218,251,0.2)`:void 0,borderColor:e.filter===n?`#61dafb`:void 0},onClick:()=>t({type:`FILTER`,payload:n}),children:n},n)),(0,f.jsxs)(`span`,{className:`demo-label`,children:[e.todos.filter(e=>!e.done).length,` remaining`]})]}),(0,f.jsxs)(`ul`,{className:`demo-list`,children:[i.length===0&&(0,f.jsx)(`li`,{className:`demo-list-item`,style:{color:`#4b5563`,justifyContent:`center`},children:`No todos`}),i.map(e=>(0,f.jsxs)(`li`,{className:`demo-list-item`,children:[(0,f.jsxs)(`span`,{style:{textDecoration:e.done?`line-through`:`none`,color:e.done?`#4b5563`:`#e2e8f0`,cursor:`pointer`,flex:1},onClick:()=>t({type:`TOGGLE`,payload:e.id}),children:[e.done?`✅`:`⬜`,` `,e.text]}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,style:{background:`rgba(248,113,113,0.1)`,borderColor:`rgba(248,113,113,0.3)`,color:`#f87171`},onClick:()=>t({type:`DELETE`,payload:e.id}),children:`Delete`})]},e.id))]})]})}function pn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useReducer`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`จัดการ complex state ด้วย Reducer pattern — เหมือน Redux แต่อยู่ใน component`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useReducer Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🔄`}),(0,f.jsxs)(`span`,{children:[`Pattern: `,(0,f.jsx)(`code`,{children:`dispatch(action)`}),` → `,(0,f.jsx)(`code`,{children:`reducer(currentState, action)`}),` → `,(0,f.jsx)(`code`,{children:`newState`})]})]}),(0,f.jsx)(p,{code:on})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Todo App — Real World Example`}),(0,f.jsx)(p,{code:sn}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`Todo Demo — useReducer`}),(0,f.jsx)(fn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useReducer vs useState`}),(0,f.jsx)(p,{code:cn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:ln})]})]})}var mn=`import { useRef } from 'react'
...
}`,gn=`import { forwardRef, useImperativeHandle } from 'react'
...
const VideoPlayer = forwardRef((props, ref) => {
  ...
  return <video ref={videoRef} {...props} />
})`,_n=[{q:`useRef กับ useState ต่างกันอย่างไร?`,a:`<strong>useState:</strong> เมื่อ setter ถูกเรียก React จะ re-render component<br>
    ...
    <code>ref</code> กลายเป็น regular prop ได้เลย`}];function vn(){let e=(0,l.useRef)(null),t=(0,l.useRef)(0),[n,r]=(0,l.useState)(``);return t.current++,(0,f.jsxs)(`div`,{className:`demo-content`,children:[(0,f.jsxs)(`div`,{className:`demo-row`,style:{marginBottom:10},children:[(0,f.jsx)(`input`,{ref:e,className:`demo-input`,value:n,onChange:e=>r(e.target.value),placeholder:`Type something...`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>e.current.focus(),children:`Focus`}),(0,f.jsx)(`button`,{className:`demo-btn-sm`,onClick:()=>r(``),children:`Clear`})]}),(0,f.jsxs)(`div`,{className:`demo-label`,children:[`Render count (via ref, no re-render): `,(0,f.jsx)(`strong`,{style:{color:`#61dafb`},children:t.current})]})]})}function yn(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Hooks`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`useRef`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`เก็บค่า mutable และ DOM references โดยไม่ trigger re-render`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useRef Basics`}),(0,f.jsxs)(`div`,{className:`callout callout-info`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`📎`}),(0,f.jsxs)(`span`,{children:[(0,f.jsx)(`code`,{children:`useRef`}),` คือ "กล่อง" ที่เก็บค่า — เปลี่ยนค่าใน `,(0,f.jsx)(`code`,{children:`.current`}),` ได้ตลอดเวลาโดยไม่ทำให้ re-render`]})]}),(0,f.jsx)(p,{code:mn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`useRef vs useState`}),(0,f.jsx)(p,{code:hn}),(0,f.jsxs)(`table`,{className:`comparison-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Feature`}),(0,f.jsx)(`th`,{children:`useState`}),(0,f.jsx)(`th`,{children:`useRef`})]})}),(0,f.jsxs)(`tbody`,{children:[(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Triggers re-render`}),(0,f.jsx)(`td`,{children:`✅ Yes`}),(0,f.jsx)(`td`,{children:`❌ No`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Mutable`}),(0,f.jsx)(`td`,{children:`No (use setter)`}),(0,f.jsx)(`td`,{children:`✅ Yes (.current)`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`DOM access`}),(0,f.jsx)(`td`,{children:`❌ No`}),(0,f.jsx)(`td`,{children:`✅ Yes`})]}),(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:`Persists across renders`}),(0,f.jsx)(`td`,{children:`✅ Yes`}),(0,f.jsx)(`td`,{children:`✅ Yes`})]})]})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interactive Demo`}),(0,f.jsxs)(`div`,{className:`demo-box`,children:[(0,f.jsx)(`div`,{className:`demo-box-header`,children:`DOM Ref + Render Counter`}),(0,f.jsx)(vn,{})]})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`forwardRef & useImperativeHandle`}),(0,f.jsxs)(`div`,{className:`callout callout-new`,children:[(0,f.jsx)(`span`,{className:`callout-icon`,children:`🆕`}),(0,f.jsxs)(`span`,{children:[`React 19: `,(0,f.jsx)(`code`,{children:`forwardRef`}),` ไม่จำเป็นแล้ว! สามารถส่ง `,(0,f.jsx)(`code`,{children:`ref`}),` เป็น regular prop ได้เลย`]})]}),(0,f.jsx)(p,{code:gn})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:_n})]})]})}var bn=`<!-- Single File Component (.vue) — โครงสร้างพื้นฐาน -->
...
h1 { color: #42b883; }
</style>`,xn=`// ref — ใช้กับค่าเดี่ยว (primitive)
...
form.username = 'alice'
form.remember = true`,Sn=`<!-- Template Syntax — วิธีเขียน HTML ใน Vue -->
...
</template>`,Cn=`// Computed — คำนวณค่าจาก reactive data (เหมือน useMemo ใน React)
...
// onMounted    ≈ useEffect(() => {}, [])
// onUpdated    ≈ useEffect(() => {})
// onUnmounted  ≈ return () => {} ใน useEffect`,Tn=`<!-- Parent Component -->
<template>
  <UserCard
    :name="userName"
    :age="userAge"
...
<\/script>`,En=`// Composable — เหมือน Custom Hook ใน React
...
// const { data, loading, error } = useFetch('/api/users')`,Dn=`// Pinia — Global State (เหมือน Zustand ใน React)
...
console.log(userStore.displayName)`,On=`// Vue Router — จัดการ URL (เหมือน React Router)
...
<\/script>`,kn=[{q:`Vue 3 กับ React ต่างกันอย่างไร?`,a:`<strong>ความเหมือน:</strong> Component-based, Virtual DOM, Reactivity, Lifecycle<br><br>
    ...
    ถ้าข้อมูลใช้แค่ใน component เดียวหรือ parent-child → ใช้ props/emit ธรรมดาพอ`}];function An(){return(0,f.jsxs)(`div`,{className:`page-container`,children:[(0,f.jsxs)(`div`,{className:`page-header`,children:[(0,f.jsx)(`div`,{className:`page-badge`,children:`Frontend`}),(0,f.jsx)(`h1`,{className:`page-title`,children:`Vue 3`}),(0,f.jsx)(`p`,{className:`page-desc`,children:`เรียนรู้ Vue 3 Composition API สำหรับ React developer แนวคิดเหมือนกัน แค่ syntax และวิธีคิดต่างออกไป`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Single File Component (SFC)`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue ใช้ไฟล์ `,(0,f.jsx)(`code`,{children:`.vue`}),` ที่รวม HTML, JS, CSS ไว้ในไฟล์เดียว แบ่งเป็น 3 ส่วนชัดเจน — ต่างจาก React ที่รวม HTML ไว้ใน JS ผ่าน JSX`]}),(0,f.jsx)(p,{code:bn,lang:`html`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`ref & reactive — Reactivity System`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue track การเปลี่ยนแปลงด้วย Proxy — ต้องห่อค่าด้วย `,(0,f.jsx)(`code`,{children:`ref`}),` หรือ `,(0,f.jsx)(`code`,{children:`reactive`}),`ก่อน Vue จึงจะรู้ว่าค่าเปลี่ยนและ re-render ให้อัตโนมัติ`]}),(0,f.jsx)(p,{code:xn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Template Syntax`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue ใช้ directive (`,(0,f.jsx)(`code`,{children:`v-if`}),`, `,(0,f.jsx)(`code`,{children:`v-for`}),`, `,(0,f.jsx)(`code`,{children:`v-model`}),`) แทน JSX expression —`,(0,f.jsx)(`code`,{children:`v-model`}),` พิเศษตรงที่ bind ค่าเข้า-ออกในบรรทัดเดียว ไม่ต้องเขียน onChange เอง`]}),(0,f.jsx)(p,{code:Sn,lang:`html`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Computed & Watch`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[(0,f.jsx)(`code`,{children:`computed`}),` คำนวณค่าจาก reactive data แล้ว cache ไว้ (เหมือน useMemo) —`,(0,f.jsx)(`code`,{children:`watch`}),` ดูการเปลี่ยนแปลงแล้วทำ side effect (เหมือน useEffect)`]}),(0,f.jsx)(p,{code:Cn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Lifecycle Hooks`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Vue มี lifecycle hook แยกชัดเจนแต่ละจังหวะ ต่างจาก React ที่ใช้ `,(0,f.jsx)(`code`,{children:`useEffect`}),`ทำทุกอย่างโดยควบคุมผ่าน dependency array`]}),(0,f.jsx)(p,{code:wn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Props & Emit`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Props ส่งข้อมูลจาก parent → child, Emit ส่ง event จาก child → parent — แทนที่จะส่ง callback function เป็น prop แบบ React, Vue ใช้ event system แยก`}),(0,f.jsx)(p,{code:Tn,lang:`html`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Composables`}),(0,f.jsxs)(`p`,{className:`section-desc`,children:[`Composable คือ function ที่แยก logic ที่ใช้ซ้ำออกมา — เหมือน Custom Hook ใน React ตั้งชื่อขึ้นต้นด้วย `,(0,f.jsx)(`code`,{children:`use`}),` เสมอ`]}),(0,f.jsx)(p,{code:En,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Pinia — Global State`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Pinia คือ state management ของ Vue 3 ทำงานคล้าย Zustand — ใช้เมื่อข้อมูลต้องแชร์ระหว่าง component ที่ไม่ได้เป็น parent-child กัน`}),(0,f.jsx)(p,{code:Dn,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Vue Router`}),(0,f.jsx)(`p`,{className:`section-desc`,children:`Vue Router จัดการ URL และ navigation — คล้าย React Router มี Navigation Guard ไว้ตรวจสอบสิทธิ์ก่อนเข้า route`}),(0,f.jsx)(p,{code:On,lang:`javascript`})]}),(0,f.jsxs)(`div`,{className:`section`,children:[(0,f.jsx)(`div`,{className:`section-title`,children:`Interview Q&A`}),(0,f.jsx)(h,{items:kn})]})]})}var jn=[{id:`home`,label:`หน้าหลัก`,icon:`🏠`},{section:`พื้นฐาน`},{id:`jsx`,label:`JSX & Components`,icon:`⚛️`},{id:`props`,label:`Props & State`,icon:`📦`},{section:`Hooks`},{id:`useeffect`,label:`useEffect`,icon:`🎣`},{id:`usecontext`,label:`useContext`,icon:`🔗`},{id:`useref`,label:`useRef`,icon:`📎`},{id:`memo`,label:`useMemo & useCallback`,icon:`⚡`},{id:`usereducer`,label:`useReducer`,icon:`🔄`},{section:`Advanced`},{id:`customhooks`,label:`Custom Hooks`,icon:`🪝`},{id:`react19`,label:`React 19 Features`,icon:`🚀`},{section:`JavaScript`},{id:`array`,label:`Array Methods`,icon:`📋`},{section:`Backend`},{id:`nodejs`,label:`Node.js`,icon:`🟩`},{section:`Database`},{id:`sql`,label:`SQL`,icon:`🗄️`},{section:`TypeScript`},{id:`typescript`,label:`TypeScript`,icon:`📘`},{section:`DevOps`},{id:`builddeploy`,label:`Build → Deploy → Browser`,icon:`🚢`},{id:`docker`,label:`Docker`,icon:`🐳`},{section:`Vue.js`},{id:`vue`,label:`Vue 3`,icon:`💚`},{section:`สัมภาษณ์`},{id:`interview`,label:`Interview Q&A`,icon:`❓`}],Mn={home:De,jsx:Ie,props:Qe,useeffect:an,usecontext:Zt,useref:yn,memo:We,usereducer:pn,customhooks:fe,react19:ot,array:x,nodejs:Nt,sql:vt,builddeploy:oe,typescript:Ht,docker:Te,vue:An,interview:ke};function Nn(){let[e,t]=(0,l.useState)(`home`),n=e=>{t(e),window.scrollTo(0,0)},r=Mn[e]||De;return(0,f.jsxs)(`div`,{className:`app`,children:[(0,f.jsxs)(`aside`,{className:`sidebar`,children:[(0,f.jsxs)(`div`,{className:`sidebar-header`,children:[(0,f.jsxs)(`div`,{className:`sidebar-title`,children:[(0,f.jsx)(`span`,{children:`⚛️`}),` React Interview`]}),(0,f.jsx)(`div`,{className:`sidebar-subtitle`,children:`Welcome to Basic Web Developer Prep · React`})]}),(0,f.jsx)(`nav`,{className:`sidebar-nav`,children:jn.map((t,r)=>t.section?(0,f.jsx)(`div`,{className:`nav-section-label`,children:t.section},r):(0,f.jsxs)(`div`,{className:`nav-item ${e===t.id?`active`:``}`,onClick:()=>n(t.id),children:[(0,f.jsx)(`span`,{className:`nav-icon`,children:t.icon}),(0,f.jsx)(`span`,{children:t.label})]},t.id))})]}),(0,f.jsx)(`main`,{className:`main-content`,children:(0,f.jsx)(r,{onNavigate:n})})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Nn,{})}));